...
module csr_shell 
	...
	input   sfp28_int_i,       
	input   sfp28_tx_fault_i  ,
	input   sfp28_los_i ,
	input   sfp28_mod_det_i   ,
	output   sfp28_tx_disable_o 
			  ...
			  altera_std_synchronizer_nocut #(.rst_value(1)) sync_ack_i_rx_rst_n_csr_clk	(
				...
				if(NUM_PHY == 3)
					begin
		                ...
		                .DR_STATUS_dr_new_cfg_applied_i            (dr_in_progress),             //Check - Driving to 0
						...
						.SFP_STATUS_sfp28_int_i             		(sfp28_int_i),       
						.SFP_STATUS_sfp28_tx_fault_i            	(sfp28_tx_fault_i ) ,
						.SFP_STATUS_sfp28_los_i             		(sfp28_los_i) ,
						.SFP_STATUS_sfp28_mod_det_i             	(sfp28_mod_det_i)   ,
						.SFP_CTRL_sfp28_tx_disable_o            	( sfp28_tx_disable_o ) 
					);
					end
