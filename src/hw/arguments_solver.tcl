...
if { ![ info exists tsn_en ] } {
 set tsn_en $TSN_EN 
} else { 
 puts "-- Accepted parameter \$tsn_en = $tsn_en"
}   

if { ![ info exists tsn_concurrent ] } {
 set tsn_concurrent $TSN_CONCURRENT
} else { 
 puts "-- Accepted parameter \$tsn_concurrent = $tsn_concurrent"
}   
