...
if {$tsn_en == 1} {
   set_component_param "agilex_hps 
					 ...
					 EMAC0_PTP 1
					 EMAC0_PPS_Enable false
					 FPGA_EMAC0_gtx_clk_mhz 312.5
	             "
	if {$tsn_concurrent == 1} {
	   ...
	   set_component_param "agilex_hps 
						 ...
						 EMAC1_PinMuxing FPGA
						 EMAC1_PTP 1
						 EMAC1_PPS_Enable false
						 FPGA_EMAC1_gtx_clk_mhz 312.5
					 "
	   set_component_param "agilex_hps 
						 EMAC2_Mode RGMII
						 EMAC2_PinMuxing FPGA
						 EMAC2_PTP 1
						 EMAC2_PPS_Enable false
						 FPGA_EMAC2_gtx_clk_mhz 125
					 "
	}			 
...
if {$tsn_en == 1} {
    ...
    export agilex_hps emac_timestamp_clk emac_timestamp_clk
    export agilex_hps emac_timestamp_data emac_timestamp_data
	export agilex_hps emac0_ptp emac0_ptp
	...
	if {$tsn_concurrent == 1} {
		...
		export agilex_hps emac1_app_rst emac1_app_rst
		#export agilex_hps emac1_mdio emac1_mdio
		export agilex_hps emac1_ptp emac1_ptp
		
		export agilex_hps emac2 emac2
		export agilex_hps emac2_app_rst emac2_app_rst
		#export agilex_hps emac2_mdio emac2_mdio
		export agilex_hps emac2_ptp emac2_ptp
