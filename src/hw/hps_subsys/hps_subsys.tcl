...
proc do_create_hps_subsys {} {
	...
	# add the components
	add_component agilex_hps ip/hps_subsys/agilex_hps.ip intel_agilex_5_soc intel_agilex_5_soc_inst
	...
	set_component_parameter_value EMAC0_PTP {1}
	...
	set_component_parameter_value FPGA_EMAC0_gtx_clk_mhz {312.5}
	set_component_parameter_value FPGA_EMAC0_md_clk_mhz {2.5}
	set_component_parameter_value FPGA_EMAC1_gtx_clk_mhz {312.5}
	set_component_parameter_value FPGA_EMAC1_md_clk_mhz {2.5}
	set_component_parameter_value FPGA_EMAC2_gtx_clk_mhz {312.5}
	...
	set_component_parameter_value HPS_IO_Enable {GPIO0:IO0 GPIO0:IO1 UART0:TX UART0:RX unused unused unused unused unused unused HCLK:HPS_OSC_CLK GPIO0:IO11 unused unused unused unused unused unused unused unused unused unused unused unused SDMMC:DATA0 SDMMC:DATA1 SDMMC:CCLK unused SDMMC:WPROT SDMMC:DATA2 SDMMC:DATA3 SDMMC:CMD unused unused unused unused unused unused unused unused unused unused unused unused unused unused unused unused}
	...
	add_instantiation_interface emac0_ptp conduit INPUT
	set_instantiation_interface_parameter_value emac0_ptp associatedClock {}
	set_instantiation_interface_parameter_value emac0_ptp associatedReset {}
	set_instantiation_interface_parameter_value emac0_ptp prSafe {false}
	add_instantiation_interface_port emac0_ptp emac0_ptp_mac_ptp_trig mac_ptp_trig 1 STD_LOGIC Input
	add_instantiation_interface_port emac0_ptp emac0_ptp_mac_ptp_pps mac_ptp_pps 1 STD_LOGIC Output
	add_instantiation_interface_port emac0_ptp emac0_ptp_mac_ptp_tstmp_data mac_ptp_tstmp_data 1 STD_LOGIC Output
	add_instantiation_interface_port emac0_ptp emac0_ptp_mac_ptp_tstmp_en mac_ptp_tstmp_en 1 STD_LOGIC Output
	...
	add_instantiation_interface_port hps_io hps_io_sdmmc_wprot sdmmc_wprot 1 STD_LOGIC Input
	...
	add_instantiation_interface_port hps_io hps_io_gpio0 gpio0 1 STD_LOGIC Bidir
	add_instantiation_interface_port hps_io hps_io_gpio1 gpio1 1 STD_LOGIC Bidir
	add_instantiation_interface_port hps_io hps_io_gpio11 gpio11 1 STD_LOGIC Bidir
	...
	save_instantiation
	add_component emif_hps ip/qsys_top/emif_hps.ip emif_hps_ph2 emif_hps_ph2_inst
	...
	set_component_parameter_value PHY_MEMCLK_FSP0_FREQ_MHZ {933.0}
	set_component_parameter_value PHY_MEMCLK_FSP0_FREQ_MHZ_AUTO_BOOL {1}
	set_component_parameter_value PHY_MEMCLK_FSP1_FREQ_MHZ {933.0}
	set_component_parameter_value PHY_MEMCLK_FSP1_FREQ_MHZ_AUTO_BOOL {1}
	set_component_parameter_value PHY_MEMCLK_FSP2_FREQ_MHZ {933.0}
	...
	set_instantiation_interface_assignment_value s0_axi4 mem_capacity_gbits {16}
	...
	set_interface_property emac_timestamp_data EXPORT_OF agilex_hps.emac_timestamp_data
	set_interface_property emac0_mdio EXPORT_OF agilex_hps.emac0_mdio
	set_interface_property emac0_ptp EXPORT_OF agilex_hps.emac0_ptp
	set_interface_property emac0_app_rst EXPORT_OF agilex_hps.emac0_app_rst
	set_interface_property emac0 EXPORT_OF agilex_hps.emac0
	set_interface_property h2f_warm_reset_handshake EXPORT_OF agilex_hps.h2f_warm_reset_handshake
	set_interface_property hps_io EXPORT_OF agilex_hps.hps_io
	set_interface_property fpga2hps_interrupt EXPORT_OF agilex_hps.fpga2hps_interrupt
