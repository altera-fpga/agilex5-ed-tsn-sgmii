...
`endif
 ...
 `ifndef PTP_EN
   `ifdef JSON_EN
      defparam dut_top_auto_tiles.dut_top__tile_0.z1577a.z1577a_inst.u_e400g_top.u_e400g_lphy.LOG2_MRK = 4;   //To enable fast link-up
      defparam dut_top_auto_tiles.dut_top__tile_0.z1577a.z1577a_inst.u_e200g_top.u_e200g_lphy.LOG2_MRK = 4;   //To enable fast link-up
   `else
      //defparam dut_top_auto_tiles.z1577a_x0_y166_n0.z1577a.z1577a_inst.u_e400g_top.u_e400g_lphy.LOG2_MRK = 4;
      //defparam dut_top_auto_tiles.z1577a_x0_y166_n0.z1577a.z1577a_inst.u_e200g_top.u_e200g_lphy.LOG2_MRK = 4;
   `endif
 `else
   //PTP - To enable fast link-up
   `ifdef JSON_EN
   defparam dut_top_auto_tiles.dut_top__tile_0.z1577a.z1577a_inst.u_e400g_top.u_e400g_lphy.LOG2_MRK = X;
   `else
   defparam dut_top_auto_tiles.z1577a_x0_y166_n0.z1577a.z1577a_inst.u_e400g_top.u_e400g_lphy.LOG2_MRK = X;
   `endif
 `endif
 `ifdef NON_ANLT_PTP
    `ifdef JSON_EN
        defparam dut_top_auto_tiles.dut_top__tile_0__reset_controller.init_fname = "../../dut_top_auto_tiles__dut_top__tile_0.mif";
    `else
        defparam dut_top_auto_tiles.z1577a_x0_y166_n0__reset_controller.init_fname = "../../dut_top__z1577a_x0_y166_n0.mif";
    `endif
`endif
...
//       end
   ...
   typedef virtual spy_interface v_if2;
    ...
    initial begin
       ...
       refclk2syspll_pulse_width = 3200;
	    #10;
    ...
    `ifdef NON_ANLT_PTP
      dut_top_auto_tiles dut_top_auto_tiles_inst();
    `endif  
//mprash2x
`ifdef ENABLE_ETH_VIP
