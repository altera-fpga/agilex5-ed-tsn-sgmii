 ...
 assign i_avalon_st_rx_ready_ip0 = 'h1;
  ...
  //DM DUT TOP instantiation
	...
	.avmm_rst_n                     (~i_reconfig_reset_ip0), 
        ...
        // MAC Status
        .xgmii_rx_link_fault_status     (),   //mprash2x: vmm db not connected
    
        // PHY Status
        .led_an                         (),   //mprash2x: vmm db not connected
        ...
        .i_reconfig_clk                 (i_reconfig_clk_ip0),
        //.i_clk_ref                      (),
        .i_rst_n                        (i_rst_n_ip0),
        ...
        //.rx_pma_clkout                  (),
        .i_refclk2pll                     (i_refclk2pll),
        .i_refclk2syspll                  (i_refclk2syspll),
    
        // Data Path Readiness
        //.channel_tx_ready               (o_tx_lanes_stable_ip0),
        //.channel_rx_ready               (o_rx_pcs_ready_ip0)
        .o_tx_lanes_stable               (o_tx_lanes_stable_ip0),
        .o_rx_pcs_ready               (o_rx_pcs_ready_ip0),
        .o_cdr_lock                   (o_cdr_lock_ip0),
        .o_clk_pll                     (o_clk_pll_ip0),
        .o_tx_pll_locked                   (o_tx_pll_locked_ip0)
