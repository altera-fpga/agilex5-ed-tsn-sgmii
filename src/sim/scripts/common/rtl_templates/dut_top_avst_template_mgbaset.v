...
output wire         o_kr_reconfig_waitrequest_kr25g,
 ...
 reg refclk_125_clk=0;
 always 
 begin 
 #4000ps refclk_125_clk = ~refclk_125_clk;
 end

 assign i_avalon_st_rx_ready_ip0 = 'h1;

  //DM DUT TOP instantiation
    mgbaset_mac_s10_phy_wrapper #(
        .NUM_OF_CHANNEL                 (2)
    ) U_DUT_WRAPPER (
 
    // Reference Clock
	.refclk_1g2p5g                  (refclk_125_clk),    
     ...
     //	.avmm_rst_n                     (~i_reconfig_reset_ip0), 
       ...
       // .rx_digitalreset                (rx_digitalreset),
        ...
        // CSR
        //.csr_address                ({i_reconfig_eth_addr_ip0,2'b0}),
