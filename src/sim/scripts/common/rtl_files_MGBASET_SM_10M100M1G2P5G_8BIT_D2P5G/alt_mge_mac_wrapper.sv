...
hps_to_mge_gmii_adapter_core (
        ...
        //clk enable  
        .phy_tx_clkena                       (rx_clkena),
        .phy_rx_clkena                       (tx_clkena),
      //  .tx_clkena                       (rx_8b_clkena),
      //  .rx_clkena                       (tx_8b_clkena),
...
//assign rx_ready_dphy = eth_env_top.dut.U_DUT.phy.alt_mge_phy_0.alt_mge_xcvr_directphy.o_rx_ready[0:0] ;
