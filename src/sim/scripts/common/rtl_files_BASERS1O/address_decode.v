...
// Generated using ACDS version 22.3 77
...
module address_decode (
	...
	wire         clk_csr_clk_clk;                                                    // clk_csr:clk_out -> [merlin_master_translator_0:clk, mm_interconnect_0:clk_csr_clk_clk, mm_to_mac:clk, mm_to_phy:clk]
	wire         clk_csr_clk_reset_reset;                                            // clk_csr:reset_n_out -> [merlin_master_translator_0:reset, mm_interconnect_0:merlin_master_translator_0_reset_reset_bridge_in_reset_reset, mm_to_mac:reset, mm_to_phy:reset]
	...
	address_decode_mm_to_mac mm_to_mac (
		...
		.uav_address       (mm_interconnect_0_mm_to_mac_avalon_universal_slave_0_address),       //   input,  width = 15, avalon_universal_slave_0.address
		.uav_burstcount    (mm_interconnect_0_mm_to_mac_avalon_universal_slave_0_burstcount),    //   input,   width = 4,                         .burstcount
		.uav_read          (mm_interconnect_0_mm_to_mac_avalon_universal_slave_0_read),          //   input,   width = 1,                         .read
		.uav_write         (mm_interconnect_0_mm_to_mac_avalon_universal_slave_0_write),         //   input,   width = 1,                         .write
		.uav_waitrequest   (mm_interconnect_0_mm_to_mac_avalon_universal_slave_0_waitrequest),   //  output,   width = 1,                         .waitrequest
		.uav_readdatavalid (mm_interconnect_0_mm_to_mac_avalon_universal_slave_0_readdatavalid), //  output,   width = 1,                         .readdatavalid
		.uav_byteenable    (mm_interconnect_0_mm_to_mac_avalon_universal_slave_0_byteenable),    //   input,   width = 4,                         .byteenable
		.uav_readdata      (mm_interconnect_0_mm_to_mac_avalon_universal_slave_0_readdata),      //  output,  width = 32,                         .readdata
		.uav_writedata     (mm_interconnect_0_mm_to_mac_avalon_universal_slave_0_writedata),     //   input,  width = 32,                         .writedata
		.uav_lock          (mm_interconnect_0_mm_to_mac_avalon_universal_slave_0_lock),          //   input,   width = 1,                         .lock
		.uav_debugaccess   (mm_interconnect_0_mm_to_mac_avalon_universal_slave_0_debugaccess),   //   input,   width = 1,                         .debugaccess
		.clk               (clk_csr_clk_clk),                                                    //   input,   width = 1,                      clk.clk
		.reset             (~clk_csr_clk_reset_reset)                                            //   input,   width = 1,                    reset.reset
	);

	address_decode_mm_to_phy mm_to_phy (
		...
		.uav_address       (mm_interconnect_0_mm_to_phy_avalon_universal_slave_0_address),       //   input,  width = 12, avalon_universal_slave_0.address
		.uav_burstcount    (mm_interconnect_0_mm_to_phy_avalon_universal_slave_0_burstcount),    //   input,   width = 4,                         .burstcount
		.uav_read          (mm_interconnect_0_mm_to_phy_avalon_universal_slave_0_read),          //   input,   width = 1,                         .read
		.uav_write         (mm_interconnect_0_mm_to_phy_avalon_universal_slave_0_write),         //   input,   width = 1,                         .write
		.uav_waitrequest   (mm_interconnect_0_mm_to_phy_avalon_universal_slave_0_waitrequest),   //  output,   width = 1,                         .waitrequest
		.uav_readdatavalid (mm_interconnect_0_mm_to_phy_avalon_universal_slave_0_readdatavalid), //  output,   width = 1,                         .readdatavalid
		.uav_byteenable    (mm_interconnect_0_mm_to_phy_avalon_universal_slave_0_byteenable),    //   input,   width = 4,                         .byteenable
		.uav_readdata      (mm_interconnect_0_mm_to_phy_avalon_universal_slave_0_readdata),      //  output,  width = 32,                         .readdata
		.uav_writedata     (mm_interconnect_0_mm_to_phy_avalon_universal_slave_0_writedata),     //   input,  width = 32,                         .writedata
		.uav_lock          (mm_interconnect_0_mm_to_phy_avalon_universal_slave_0_lock),          //   input,   width = 1,                         .lock
		.uav_debugaccess   (mm_interconnect_0_mm_to_phy_avalon_universal_slave_0_debugaccess),   //   input,   width = 1,                         .debugaccess
		.clk               (clk_csr_clk_clk),                                                    //   input,   width = 1,                      clk.clk
		.reset             (~clk_csr_clk_reset_reset)                                            //   input,   width = 1,                    reset.reset
	);

	address_decode_altera_mm_interconnect_1920_kwlaweq mm_interconnect_0 (
		...
		.mm_to_mac_avalon_universal_slave_0_address                         (mm_interconnect_0_mm_to_mac_avalon_universal_slave_0_address),       //  output,  width = 15,                     mm_to_mac_avalon_universal_slave_0.address
		.mm_to_mac_avalon_universal_slave_0_write                           (mm_interconnect_0_mm_to_mac_avalon_universal_slave_0_write),         //  output,   width = 1,                                                       .write
		.mm_to_mac_avalon_universal_slave_0_read                            (mm_interconnect_0_mm_to_mac_avalon_universal_slave_0_read),          //  output,   width = 1,                                                       .read
		.mm_to_mac_avalon_universal_slave_0_readdata                        (mm_interconnect_0_mm_to_mac_avalon_universal_slave_0_readdata),      //   input,  width = 32,                                                       .readdata
		.mm_to_mac_avalon_universal_slave_0_writedata                       (mm_interconnect_0_mm_to_mac_avalon_universal_slave_0_writedata),     //  output,  width = 32,                                                       .writedata
		.mm_to_mac_avalon_universal_slave_0_burstcount                      (mm_interconnect_0_mm_to_mac_avalon_universal_slave_0_burstcount),    //  output,   width = 4,                                                       .burstcount
		.mm_to_mac_avalon_universal_slave_0_byteenable                      (mm_interconnect_0_mm_to_mac_avalon_universal_slave_0_byteenable),    //  output,   width = 4,                                                       .byteenable
		.mm_to_mac_avalon_universal_slave_0_readdatavalid                   (mm_interconnect_0_mm_to_mac_avalon_universal_slave_0_readdatavalid), //   input,   width = 1,                                                       .readdatavalid
		.mm_to_mac_avalon_universal_slave_0_waitrequest                     (mm_interconnect_0_mm_to_mac_avalon_universal_slave_0_waitrequest),   //   input,   width = 1,                                                       .waitrequest
		.mm_to_mac_avalon_universal_slave_0_lock                            (mm_interconnect_0_mm_to_mac_avalon_universal_slave_0_lock),          //  output,   width = 1,                                                       .lock
		.mm_to_mac_avalon_universal_slave_0_debugaccess                     (mm_interconnect_0_mm_to_mac_avalon_universal_slave_0_debugaccess),   //  output,   width = 1,                                                       .debugaccess
		.mm_to_phy_avalon_universal_slave_0_address                         (mm_interconnect_0_mm_to_phy_avalon_universal_slave_0_address),       //  output,  width = 12,                     mm_to_phy_avalon_universal_slave_0.address
		.mm_to_phy_avalon_universal_slave_0_write                           (mm_interconnect_0_mm_to_phy_avalon_universal_slave_0_write),         //  output,   width = 1,                                                       .write
		.mm_to_phy_avalon_universal_slave_0_read                            (mm_interconnect_0_mm_to_phy_avalon_universal_slave_0_read),          //  output,   width = 1,                                                       .read
		.mm_to_phy_avalon_universal_slave_0_readdata                        (mm_interconnect_0_mm_to_phy_avalon_universal_slave_0_readdata),      //   input,  width = 32,                                                       .readdata
		.mm_to_phy_avalon_universal_slave_0_writedata                       (mm_interconnect_0_mm_to_phy_avalon_universal_slave_0_writedata),     //  output,  width = 32,                                                       .writedata
		.mm_to_phy_avalon_universal_slave_0_burstcount                      (mm_interconnect_0_mm_to_phy_avalon_universal_slave_0_burstcount),    //  output,   width = 4,                                                       .burstcount
		.mm_to_phy_avalon_universal_slave_0_byteenable                      (mm_interconnect_0_mm_to_phy_avalon_universal_slave_0_byteenable),    //  output,   width = 4,                                                       .byteenable
		.mm_to_phy_avalon_universal_slave_0_readdatavalid                   (mm_interconnect_0_mm_to_phy_avalon_universal_slave_0_readdatavalid), //   input,   width = 1,                                                       .readdatavalid
		.mm_to_phy_avalon_universal_slave_0_waitrequest                     (mm_interconnect_0_mm_to_phy_avalon_universal_slave_0_waitrequest),   //   input,   width = 1,                                                       .waitrequest
		.mm_to_phy_avalon_universal_slave_0_lock                            (mm_interconnect_0_mm_to_phy_avalon_universal_slave_0_lock),          //  output,   width = 1,                                                       .lock
		.mm_to_phy_avalon_universal_slave_0_debugaccess                     (mm_interconnect_0_mm_to_phy_avalon_universal_slave_0_debugaccess),   //  output,   width = 1,                                                       .debugaccess
