...
module alt_mge_rd #(
   ...
   output wire    i_sss_req_ip0,
   output wire    i_sss_gnt, 
    // MAC TX User Frame
   ...
   input  wire	    clk_156p25,
    input  wire	    sytem_pll_clk,
   ...
   input               i_rst_n , 
    ...
    alt_mge_phy_0 phy (
        ...
        .rx_cdr_refclk_p                (clk_156p25),
        .rx_cdr_refclk_n                (~clk_156p25),
        .tx_pll_refclk_p                (clk_156p25),
        .tx_pll_refclk_n                (~clk_156p25),
        .system_pll_clk_n               (~sytem_pll_clk),
        .system_pll_clk_p               (sytem_pll_clk), 
        // Reset
        .reset                          (reset),
        .tx_digitalreset                (tx_digitalreset),
        .rx_digitalreset                (rx_digitalreset),
     //   .tx_analogreset                 (tx_analogreset), pbalakri : Not found in HAS 
     //   .rx_analogreset                 (rx_analogreset), pbalakri : Not found in HAS 
        .flux_clk                       (i_flux_clk_ip0),
    ...
    //    .tx_cal_busy                    (tx_cal_busy), pbalakri : Available in MRPHY
    //    HAS , but still failing to check with Akruti 
   //      .rx_cal_busy                    (rx_cal_busy),
        ...
        .reconfig_read                  (0),
        .reconfig_write                 (0),
        .reconfig_writedata             (0),
        .reconfig_readdata              (0),
        .reconfig_waitrequest           (0),  // pbalakri : Available in HAS , to check with Akruti 
        .sss_grant(i_sss_gnt),
        .sss_req(i_sss_req_ip0)

 //       .rx_analogreset_stat  (rx_analogreset_stat),  //  rx_analogreset_stat.rx_analogreset_stat pbalakri : Not available in HAS 
