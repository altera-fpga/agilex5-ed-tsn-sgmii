...
////  ===================================================================================================
//
//// Override ETH_STOP_ON_IDLE in all test_param.sv files
//`ifdef ETH_MGBASET_MAC_S10_PHY_1G_2P5G_MODE_DE
//`ifndef ETH_MGBASET_MAC_S10_PHY_SGMII_MODE_DE
//    `undef  ETH_STOP_ON_IDLE
//    `define ETH_STOP_ON_IDLE                   50000    
//`endif
//`endif


module mgbaset_mac_s10_phy_wrapper (
...
always #775.760001 refclk_10g = ~refclk_10g; //644.53125

initial clk_156_25 = 1'b0;
always #3200 clk_156_25 = ~clk_156_25;

initial clk_312_5 = 1'b0;
always #1600 clk_312_5 = ~clk_312_5;

assign refclk_10g_out = refclk_10g;


assign mac_clk = clk_312_5;
...
//            .pll_refclk0    (refclk_10g), 
//            .pll_cal_busy   (),    
//            .outclk_div2    (mac64b_clk),             // 156.25MHz clock
//            .outclk_div1    (mac_clk),             // 312.50MHz clock
//            .pll_locked     (core_pll_locked)
//        ); 
...
//        defparam `ETH_TB_TOP_WRAPPER.U_TOP_DUT_WRAPPER.U_DUT_WRAPPER.U_DUT.u_rcfg_a10.u_mif_master.MODE_2_INIT_FILE = "rcfg/alt_mge_rcfg_a10_xcvr_10g.mif";
        ...
        //`ifdef ETH_MGBASET_MAC_S10_PHY_SGMII_MODE_DE
        //    defparam `ETH_TB_TOP_WRAPPER.U_TOP_DUT_WRAPPER.U_DUT_WRAPPER.U_DUT.u_rcfg.u_mif_master.MODE_0_INIT_FILE = "LL10G_1G_2_5G_10G_SGMII/alt_mge_phy_reconfig_parameters_CFG0.mif";
        //    defparam `ETH_TB_TOP_WRAPPER.U_TOP_DUT_WRAPPER.U_DUT_WRAPPER.U_DUT.u_rcfg.u_mif_master.MODE_1_INIT_FILE = "LL10G_1G_2_5G_10G_SGMII/alt_mge_phy_reconfig_parameters_CFG1.mif";
        //    defparam `ETH_TB_TOP_WRAPPER.U_TOP_DUT_WRAPPER.U_DUT_WRAPPER.U_DUT.u_rcfg.u_mif_master.MODE_2_INIT_FILE = "LL10G_1G_2_5G_10G_SGMII/alt_mge_phy_reconfig_parameters_CFG2.mif";
        //`else
        //    defparam `ETH_TB_TOP_WRAPPER.U_TOP_DUT_WRAPPER.U_DUT_WRAPPER.U_DUT.u_rcfg_a10.u_mif_master.MODE_0_INIT_FILE = "mgbaset_s10/alt_mge_phy_reconfig_parameters_CFG0.mif";
        //    defparam `ETH_TB_TOP_WRAPPER.U_TOP_DUT_WRAPPER.U_DUT_WRAPPER.U_DUT.u_rcfg_a10.u_mif_master.MODE_1_INIT_FILE = "mgbaset_s10/alt_mge_phy_reconfig_parameters_CFG1.mif";
        //    defparam `ETH_TB_TOP_WRAPPER.U_TOP_DUT_WRAPPER.U_DUT_WRAPPER.U_DUT.u_rcfg_a10.u_mif_master.MODE_2_INIT_FILE = "mgbaset_s10/alt_mge_phy_reconfig_parameters_CFG2.mif";
        //`endif        
