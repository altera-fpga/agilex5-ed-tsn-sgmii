...
`define DUT_TOP top_tb.dut
`define TSN_RTB top_tb.tsn_rtb_i
`define HPS_RTB top_tb.hps_rtb_i
...
interface eth_testsuite_tasks_intf;
 /* ip number which is accessed by this interface, must be assigned from top */
  ...
  `else
    `BFM_WAIT(`TSN_RTB.svt_ethernet_txrx_if,if_mon.usr_chk_sync_up_rx,0)
  `endif
    #5ns;
  endtask 
  ...
  `else
    `BFM_WAIT(`TSN_RTB.svt_ethernet_txrx_if,if_mon.usr_chk_sync_up_rx,1)
  `endif
  endtask
  ...
  function set_enable_a_non_missing_startofpacket (bit en);
   ...
   `ifdef AVST_MODE
    //`RTB_FUNCTION(`HPS_RTB.avst_rx_rtb,monitor.u_bfm.monitor_assertion.set_enable_a_non_missing_startofpacket(en))
   `endif
  endfunction
  ...
  function set_enable_a_non_missing_endofpacket (bit en);
    `uvm_info("set_enable_a_non_missing_startofpacket", $sformatf(" set_enable_a_non_missing_startofpacket assertion in avst_rx_rtb is set to %d", en), UVM_LOW)
   `ifdef AVST_MODE
     //`RTB_FUNCTION(`HPS_RTB.avst_rx_rtb,monitor.u_bfm.monitor_assertion.set_enable_a_non_missing_endofpacket(en))
   `endif
  endfunction
  ...
  function avst_set_enable_a_mon_assertion (bit en);
   ...
   `ifdef AVST_MODE
    //`RTB_FUNCTION(`HPS_RTB.avst_rx_rtb,monitor.u_bfm.monitor_assertion.set_enable_a_non_missing_endofpacket(en))
    //`RTB_FUNCTION(`HPS_RTB.avst_rx_rtb,monitor.u_bfm.monitor_assertion.set_enable_a_non_missing_startofpacket(en))
    //`RTB_FUNCTION(`HPS_RTB.avst_rx_rtb,monitor.u_bfm.monitor_assertion.set_enable_a_valid_legal(en))
    //`RTB_FUNCTION(`HPS_RTB.avst_rx_rtb,monitor.u_bfm.monitor_assertion.set_enable_a_empty_legal(en))
    //`RTB_FUNCTION(`HPS_RTB.avst_rx_rtb,monitor.u_bfm.monitor_assertion.set_enable_a_no_data_outside_packet(en))
    //`RTB_FUNCTION(`HPS_RTB.avst_rx_rtb,monitor.u_bfm.monitor_assertion.set_enable_a_less_than_max_channel(en))
   `endif
  endfunction
