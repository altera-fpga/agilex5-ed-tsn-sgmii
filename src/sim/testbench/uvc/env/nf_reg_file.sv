...
// ---------------------------
 ...
 class registers_urm  extends  uvm_reg_block;
	  ...
	  sgmii_control = sgmii_control_urm::type_id::create("sgmii_control");
          ...
          this.default_map.add_reg(control, `UVM_REG_ADDR_WIDTH'h0490, "RW");
          this.default_map.add_reg(status, `UVM_REG_ADDR_WIDTH'h0491, "RO");
...
;
          ...
          this.default_map.add_reg(tx_stats_framesErr0, `UVM_REG_ADDR_WIDTH'h1C03, "RO");
          ...
          this.default_map.add_reg(mac_stats_cntr_tx_mcast_data_err_lo, `UVM_REG_ADDR_WIDTH'h1154, "RO");
