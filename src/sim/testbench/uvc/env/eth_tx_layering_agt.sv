...
`ifndef ETH_TX_LAYERING_AGT__SV
`define ETH_TX_LAYERING_AGT__SV


class eth_tx_layering_agt extends uvm_agent;
   // ToDo: add uvm agent properties here
   protected uvm_active_passive_enum is_active = UVM_ACTIVE;
   eth_tx_layering_sqr mast_sqr;
   eth_tx_layering_drv mast_drv;
   eth_tx_layering_mon mast_mon;
   typedef virtual eth_sideband_interface vif;
   vif mast_agt_if; 

   `uvm_component_utils_begin(eth_tx_layering_agt)
   ...
   virtual function void build_phase(uvm_phase phase);
      ...
      mast_mon = eth_tx_layering_mon::type_id::create("mast_mon", this);
      if (is_active == UVM_ACTIVE) begin
         mast_sqr = eth_tx_layering_sqr::type_id::create("mast_sqr", this);
         mast_drv = eth_tx_layering_drv::type_id::create("mast_drv", this);
      end
...
endclass: eth_tx_layering_agt
 
`endif // ETH_TX_LAYERING_AGT__SV
