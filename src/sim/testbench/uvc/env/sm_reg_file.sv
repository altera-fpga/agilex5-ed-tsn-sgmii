...
// agreement for further details.
 ...
 class control_urm  extends uvm_reg; 
	  ...
	  RESTART_AUTO_NEGOTIATION = uvm_reg_field::type_id::create("RESTART_AUTO_NEGOTIATION"); 
          // configure 
          RESTART_AUTO_NEGOTIATION.configure( 
         .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (9), 
          .access                 ("RW"), 
	  ...
	  AUTO_NEGOTIATION_ENABLE = uvm_reg_field::type_id::create("AUTO_NEGOTIATION_ENABLE"); 
          // configure 
          AUTO_NEGOTIATION_ENABLE.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (12), 
          .access                 ("RW"), 
 ...
 class status_urm  extends uvm_reg; 
       ...
       rand uvm_reg_field AUTO_NEGOTIATION_ABILITY; 
       rand uvm_reg_field Reserved; 
	  ...
	  LINK_STATUS = uvm_reg_field::type_id::create("LINK_STATUS"); 
          ...
          // create bitfield   
          AUTO_NEGOTIATION_ABILITY = uvm_reg_field::type_id::create("AUTO_NEGOTIATION_ABILITY"); 
          // configure 
          AUTO_NEGOTIATION_ABILITY.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (3), 
          .access                 ("RO"), 
          ...
          AUTO_NEGOTIATION_COMPLETE = uvm_reg_field::type_id::create("AUTO_NEGOTIATION_COMPLETE"); 
          // configure 
          AUTO_NEGOTIATION_COMPLETE.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (5), 
          .access                 ("RO"), 
...
// ---------------------------
 class sgmii_dev_ability_urm  extends uvm_reg; 
       ...
       rand uvm_reg_field PS1; 
       rand uvm_reg_field PS2; 
       rand uvm_reg_field Reserved ; 
       rand uvm_reg_field RF1; 
       rand uvm_reg_field RF2; 
       ...
       virtual function void build(); 
          ...
          // create bitfield   
          FD = uvm_reg_field::type_id::create("FD"); 
          // configure 
          FD.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          ...
          HD = uvm_reg_field::type_id::create("HD"); 
          // configure 
          HD.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          ...
          PS1 = uvm_reg_field::type_id::create("PS1"); 
          // configure 
          PS1.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          ...
          PS2 = uvm_reg_field::type_id::create("PS2"); 
          // configure 
          PS2.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          ...
          RF2 = uvm_reg_field::type_id::create("RF2"); 
          // configure 
          RF2.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          ...
          NP = uvm_reg_field::type_id::create("NP"); 
          // configure 
          NP.configure( 
          .parent                 ( this ), 
          .size                   (1), 
...
// ---------------------------
 class an_expansion_urm  extends uvm_reg; 
       ...
       rand uvm_reg_field Reserved; 
       rand uvm_reg_field next_page_able; 
       ...
       virtual function void build(); 
          ...
          next_page_able = uvm_reg_field::type_id::create("next_page_able"); 
          // configure 
          next_page_able.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (2), 
          .access                 ("RO"), 
...
// ---------------------------
 ...
 class registers_urm  extends  uvm_reg_block;
	  ...
	  sgmii_control = sgmii_control_urm::type_id::create("sgmii_control");
          ...
          //mapping
          //this.default_map.add_reg(logical_channel_number, `UVM_REG_ADDR_WIDTH'h0111, "RW");
          //this.default_map.add_reg(control, `UVM_REG_ADDR_WIDTH'h0000, "RW");
          //this.default_map.add_reg(status, `UVM_REG_ADDR_WIDTH'h0001, "RO");
          this.default_map.add_reg(mac_cfg_txmac_saddrl, `UVM_REG_ADDR_WIDTH'h0010, "RW");
          this.default_map.add_reg(mac_cfg_txmac_saddrh, `UVM_REG_ADDR_WIDTH'h0011, "RW");
          this.default_map.add_reg(mac_reset_control, `UVM_REG_ADDR_WIDTH'h001F, "RW");
          this.default_map.add_reg(tx_packet_control, `UVM_REG_ADDR_WIDTH'h0020, "RW");
          this.default_map.add_reg(tx_transfer_status, `UVM_REG_ADDR_WIDTH'h0022, "RO");
          this.default_map.add_reg(tx_pad_control, `UVM_REG_ADDR_WIDTH'h0024, "RW");
          this.default_map.add_reg(tx_crc_control, `UVM_REG_ADDR_WIDTH'h0026, "RW");
          this.default_map.add_reg(tx_preamble_control, `UVM_REG_ADDR_WIDTH'h0028, "RO");//updated access from RW to RO because register will update only when passthrough preamble is 1
          this.default_map.add_reg(tx_src_addr_override, `UVM_REG_ADDR_WIDTH'h002A, "RW");
          this.default_map.add_reg(mac_cfg_max_tx_size_config, `UVM_REG_ADDR_WIDTH'h002C, "RW");
          this.default_map.add_reg(tx_vlan_detection, `UVM_REG_ADDR_WIDTH'h002D, "RW");
          this.default_map.add_reg(tx_ipg_10g, `UVM_REG_ADDR_WIDTH'h002E, "RW");
          this.default_map.add_reg(tx_ipg_10M_100M_1G, `UVM_REG_ADDR_WIDTH'h002F, "RW");
          this.default_map.add_reg(tx_underflow_counter0, `UVM_REG_ADDR_WIDTH'h003E, "RO");
          this.default_map.add_reg(tx_underflow_counter1, `UVM_REG_ADDR_WIDTH'h003F, "RO");
          this.default_map.add_reg(tx_pauseframe_control, `UVM_REG_ADDR_WIDTH'h0040, "RW");
          this.default_map.add_reg(mac_cfg_tx_pause_quanta, `UVM_REG_ADDR_WIDTH'h0042, "RW");
          this.default_map.add_reg(mac_cfg_retransmit_xoff_holdoff_quanta, `UVM_REG_ADDR_WIDTH'h0043, "RW");
          this.default_map.add_reg(tx_pauseframe_enable, `UVM_REG_ADDR_WIDTH'h0044, "RW");
          this.default_map.add_reg(tx_pfc_priority_enable, `UVM_REG_ADDR_WIDTH'h0046, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_0, `UVM_REG_ADDR_WIDTH'h0048, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_1, `UVM_REG_ADDR_WIDTH'h0049, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_2, `UVM_REG_ADDR_WIDTH'h004A, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_3, `UVM_REG_ADDR_WIDTH'h004B, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_4, `UVM_REG_ADDR_WIDTH'h004C, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_5, `UVM_REG_ADDR_WIDTH'h004D, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_6, `UVM_REG_ADDR_WIDTH'h004E, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_7, `UVM_REG_ADDR_WIDTH'h004F, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_0, `UVM_REG_ADDR_WIDTH'h0058, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_1, `UVM_REG_ADDR_WIDTH'h0059, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_2, `UVM_REG_ADDR_WIDTH'h005A, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_3, `UVM_REG_ADDR_WIDTH'h005B, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_4, `UVM_REG_ADDR_WIDTH'h005C, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_5, `UVM_REG_ADDR_WIDTH'h005D, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_6, `UVM_REG_ADDR_WIDTH'h005E, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_7, `UVM_REG_ADDR_WIDTH'h005F, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(tx_unidir_control, `UVM_REG_ADDR_WIDTH'h0070, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(rx_transfer_control, `UVM_REG_ADDR_WIDTH'h00A0, "RW");
          this.default_map.add_reg(rx_transfer_status, `UVM_REG_ADDR_WIDTH'h00A2, "RO");
          this.default_map.add_reg(rx_padcrc_control, `UVM_REG_ADDR_WIDTH'h00A4, "RW");
          this.default_map.add_reg(rx_crccheck_control, `UVM_REG_ADDR_WIDTH'h00A6, "RW");
          this.default_map.add_reg(rx_custom_preamble_forward, `UVM_REG_ADDR_WIDTH'h00A8, "RO");//updated access from RW to RO because register will update only when passthrough preamble is 1
          this.default_map.add_reg(rx_preamble_control, `UVM_REG_ADDR_WIDTH'h00AA, "RO");//updated access from RW to RO because register will update only when passthrough preamble is 1
          this.default_map.add_reg(rx_frame_control, `UVM_REG_ADDR_WIDTH'h00AC, "RW");
          this.default_map.add_reg(mac_cfg_max_rx_size_config, `UVM_REG_ADDR_WIDTH'h00AE, "RW");
          this.default_map.add_reg(rx_vlan_detection, `UVM_REG_ADDR_WIDTH'h00AF, "RW");
          this.default_map.add_reg(rx_frame_spaddr0_0, `UVM_REG_ADDR_WIDTH'h00B0, "RW");
          this.default_map.add_reg(rx_frame_spaddr0_1, `UVM_REG_ADDR_WIDTH'h00B1, "RW");
          this.default_map.add_reg(rx_frame_spaddr1_0, `UVM_REG_ADDR_WIDTH'h00B2, "RW");
          this.default_map.add_reg(rx_frame_spaddr1_1, `UVM_REG_ADDR_WIDTH'h00B3, "RW");
          this.default_map.add_reg(rx_frame_spaddr2_0, `UVM_REG_ADDR_WIDTH'h00B4, "RW");
          this.default_map.add_reg(rx_frame_spaddr2_1, `UVM_REG_ADDR_WIDTH'h00B5, "RW");
          this.default_map.add_reg(rx_frame_spaddr3_0, `UVM_REG_ADDR_WIDTH'h00B6, "RW");
          this.default_map.add_reg(rx_frame_spaddr3_1, `UVM_REG_ADDR_WIDTH'h00B7, "RW");
          this.default_map.add_reg(rx_pfc_control, `UVM_REG_ADDR_WIDTH'h00C0, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(rx_pktovrflow_error0, `UVM_REG_ADDR_WIDTH'h00FC, "RO");
          this.default_map.add_reg(rx_pktovrflow_error1, `UVM_REG_ADDR_WIDTH'h00FD, "RO");
          this.default_map.add_reg(rx_pktovrflow_etherStatsDropEvents0, `UVM_REG_ADDR_WIDTH'h00FE, "RO");
          this.default_map.add_reg(rx_pktovrflow_etherStatsDropEvents1, `UVM_REG_ADDR_WIDTH'h00FF, "RO");
          this.default_map.add_reg(tx_stats_clr, `UVM_REG_ADDR_WIDTH'h0140, "WRC");
          this.default_map.add_reg(rx_stats_clr, `UVM_REG_ADDR_WIDTH'h01C0, "WRC");
          this.default_map.add_reg(tx_stats_framesOK0, `UVM_REG_ADDR_WIDTH'h0142, "RO");
          this.default_map.add_reg(tx_stats_framesOK1, `UVM_REG_ADDR_WIDTH'h0143, "RO");
          this.default_map.add_reg(rx_stats_framesOK0, `UVM_REG_ADDR_WIDTH'h01C2, "RO");
          this.default_map.add_reg(rx_stats_framesOK1, `UVM_REG_ADDR_WIDTH'h01C3, "RO");
          this.default_map.add_reg(tx_stats_framesErr0, `UVM_REG_ADDR_WIDTH'h0144, "RO");
          this.default_map.add_reg(tx_stats_framesErr1, `UVM_REG_ADDR_WIDTH'h0145, "RO");
          this.default_map.add_reg(rx_stats_framesErr0, `UVM_REG_ADDR_WIDTH'h01C4, "RO");
          this.default_map.add_reg(rx_stats_framesErr1, `UVM_REG_ADDR_WIDTH'h01C5, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_fcs_lo, `UVM_REG_ADDR_WIDTH'h01C6, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_fcs_hi, `UVM_REG_ADDR_WIDTH'h01C7, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_payloadoctetsok_lo, `UVM_REG_ADDR_WIDTH'h0148, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_payloadoctetsok_hi, `UVM_REG_ADDR_WIDTH'h0149, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_payloadoctetsok_lo, `UVM_REG_ADDR_WIDTH'h01C8, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_payloadoctetsok_hi, `UVM_REG_ADDR_WIDTH'h01C9, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_pause_lo, `UVM_REG_ADDR_WIDTH'h014A, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_pause_hi, `UVM_REG_ADDR_WIDTH'h014B, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_pause_lo, `UVM_REG_ADDR_WIDTH'h01CA, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_pause_hi, `UVM_REG_ADDR_WIDTH'h01CB, "RO");
          this.default_map.add_reg(tx_stats_ifErrors0, `UVM_REG_ADDR_WIDTH'h014C, "RO");
          this.default_map.add_reg(tx_stats_ifErrors1, `UVM_REG_ADDR_WIDTH'h014D, "RO");
          this.default_map.add_reg(rx_stats_ifErrors0, `UVM_REG_ADDR_WIDTH'h01CC, "RO");
          this.default_map.add_reg(rx_stats_ifErrors1, `UVM_REG_ADDR_WIDTH'h01CD, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_ucast_data_ok_lo, `UVM_REG_ADDR_WIDTH'h014E, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_ucast_data_ok_hi, `UVM_REG_ADDR_WIDTH'h014F, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_ucast_data_ok_lo, `UVM_REG_ADDR_WIDTH'h01CE, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_ucast_data_ok_hi, `UVM_REG_ADDR_WIDTH'h01CF, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_utcast_data_err_lo, `UVM_REG_ADDR_WIDTH'h0150, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_utcast_data_err_hi, `UVM_REG_ADDR_WIDTH'h0151, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_ucast_data_err_lo, `UVM_REG_ADDR_WIDTH'h01D0, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_ucast_data_err_hi, `UVM_REG_ADDR_WIDTH'h01D1, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_mcast_data_ok_lo, `UVM_REG_ADDR_WIDTH'h0152, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_mcast_data_ok_hi, `UVM_REG_ADDR_WIDTH'h0153, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_mcast_data_ok_lo, `UVM_REG_ADDR_WIDTH'h01D2, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_mcast_data_ok_hi, `UVM_REG_ADDR_WIDTH'h01D3, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_mcast_data_err_lo, `UVM_REG_ADDR_WIDTH'h0154, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_mcast_data_err_hi, `UVM_REG_ADDR_WIDTH'h0155, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_mcast_data_err_lo, `UVM_REG_ADDR_WIDTH'h01D4, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_mcast_data_err_hi, `UVM_REG_ADDR_WIDTH'h01D5, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_bcast_data_ok_lo, `UVM_REG_ADDR_WIDTH'h0156, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_bcast_data_ok_hi, `UVM_REG_ADDR_WIDTH'h0157, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_bcast_data_ok_lo, `UVM_REG_ADDR_WIDTH'h01D6, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_bcast_data_ok_hi, `UVM_REG_ADDR_WIDTH'h01D7, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_bcast_data_err_lo, `UVM_REG_ADDR_WIDTH'h0158, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_bcast_data_err_hi, `UVM_REG_ADDR_WIDTH'h0159, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_bcast_data_err_lo, `UVM_REG_ADDR_WIDTH'h01D8, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_bcast_data_err_hi, `UVM_REG_ADDR_WIDTH'h01D9, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_octetsok_lo, `UVM_REG_ADDR_WIDTH'h015A, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_octetsok_hi, `UVM_REG_ADDR_WIDTH'h015B, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_octetsok_lo, `UVM_REG_ADDR_WIDTH'h01DA, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_octetsok_hi, `UVM_REG_ADDR_WIDTH'h01DB, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_st_lo, `UVM_REG_ADDR_WIDTH'h015C, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_st_hi, `UVM_REG_ADDR_WIDTH'h015D, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_st_lo, `UVM_REG_ADDR_WIDTH'h01DC, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_st_hi, `UVM_REG_ADDR_WIDTH'h01DD, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_runt_lo, `UVM_REG_ADDR_WIDTH'h015E, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_runt_hi, `UVM_REG_ADDR_WIDTH'h015F, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_runt_lo, `UVM_REG_ADDR_WIDTH'h01DE, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_runt_hi, `UVM_REG_ADDR_WIDTH'h01DF, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_oversize_lo, `UVM_REG_ADDR_WIDTH'h0160, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_oversize_hi, `UVM_REG_ADDR_WIDTH'h0161, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_oversize_lo, `UVM_REG_ADDR_WIDTH'h01E0, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_oversize_hi, `UVM_REG_ADDR_WIDTH'h01E1, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_64b_lo, `UVM_REG_ADDR_WIDTH'h0162, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_64b_hi, `UVM_REG_ADDR_WIDTH'h0163, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_64b_lo, `UVM_REG_ADDR_WIDTH'h01E2, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_64b_hi, `UVM_REG_ADDR_WIDTH'h01E3, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_65to127b_lo, `UVM_REG_ADDR_WIDTH'h0164, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_65to127b_hi, `UVM_REG_ADDR_WIDTH'h0165, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_65to127b_lo, `UVM_REG_ADDR_WIDTH'h01E4, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_65to127b_hi, `UVM_REG_ADDR_WIDTH'h01E5, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_128to255b_lo, `UVM_REG_ADDR_WIDTH'h0166, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_128to255b_hi, `UVM_REG_ADDR_WIDTH'h0167, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_128to255b_lo, `UVM_REG_ADDR_WIDTH'h01E6, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_128to255b_hi, `UVM_REG_ADDR_WIDTH'h01E7, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_256to511b_lo, `UVM_REG_ADDR_WIDTH'h0168, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_256to511b_hi, `UVM_REG_ADDR_WIDTH'h0169, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_256to511b_lo, `UVM_REG_ADDR_WIDTH'h01E8, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_256to511b_hi, `UVM_REG_ADDR_WIDTH'h01E9, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_512to1023b_lo, `UVM_REG_ADDR_WIDTH'h016A, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_512to1023b_hi, `UVM_REG_ADDR_WIDTH'h016B, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_512to1023b_lo, `UVM_REG_ADDR_WIDTH'h01EA, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_512to1023b_hi, `UVM_REG_ADDR_WIDTH'h01EB, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_1024to1518b_lo, `UVM_REG_ADDR_WIDTH'h016C, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_1024to1518b_hi, `UVM_REG_ADDR_WIDTH'h016D, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_1024to1518b_lo, `UVM_REG_ADDR_WIDTH'h01EC, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_1024to1518b_hi, `UVM_REG_ADDR_WIDTH'h01ED, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_1519tomaxb_lo, `UVM_REG_ADDR_WIDTH'h016E, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_1519tomaxb_hi, `UVM_REG_ADDR_WIDTH'h016F, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_1519tomaxb_lo, `UVM_REG_ADDR_WIDTH'h01EE, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_1519tomaxb_hi, `UVM_REG_ADDR_WIDTH'h01EF, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_fragments_lo, `UVM_REG_ADDR_WIDTH'h01F0, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_fragments_hi, `UVM_REG_ADDR_WIDTH'h01F1, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_jabbers_lo, `UVM_REG_ADDR_WIDTH'h01F2, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_jabbers_hi, `UVM_REG_ADDR_WIDTH'h01F3, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_fcs_err_okpkt_lo, `UVM_REG_ADDR_WIDTH'h01F4, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_fcs_err_okpkt_hi, `UVM_REG_ADDR_WIDTH'h01F5, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_ucast_ctrl_lo, `UVM_REG_ADDR_WIDTH'h0176, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_ucast_ctrl_hi, `UVM_REG_ADDR_WIDTH'h0177, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_ucast_ctrl_lo, `UVM_REG_ADDR_WIDTH'h01F6, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_ucast_ctrl_hi, `UVM_REG_ADDR_WIDTH'h01F7, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_mcast_ctrl_lo, `UVM_REG_ADDR_WIDTH'h0178, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_mcast_ctrl_hi, `UVM_REG_ADDR_WIDTH'h0179, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_mcast_ctrl_lo, `UVM_REG_ADDR_WIDTH'h01F8, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_mcast_ctrl_hi, `UVM_REG_ADDR_WIDTH'h01F9, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_bcast_ctrl_lo, `UVM_REG_ADDR_WIDTH'h017A, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_bcast_ctrl_hi, `UVM_REG_ADDR_WIDTH'h017B, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_bcast_ctrl_lo, `UVM_REG_ADDR_WIDTH'h01FA, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_bcast_ctrl_hi, `UVM_REG_ADDR_WIDTH'h01FB, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_pfc_lo, `UVM_REG_ADDR_WIDTH'h017C, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_pfc_hi, `UVM_REG_ADDR_WIDTH'h017D, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_pfc_lo, `UVM_REG_ADDR_WIDTH'h01FC, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_pfc_hi, `UVM_REG_ADDR_WIDTH'h01FD, "RO");
          ...
          this.default_map.add_reg(sgmii_dev_ability, `UVM_REG_ADDR_WIDTH'h6004, "RW");
          this.default_map.add_reg(sgmii_partner_ability, `UVM_REG_ADDR_WIDTH'h6005, "RW");
