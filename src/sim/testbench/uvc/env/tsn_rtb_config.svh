...
`ifndef __TSN_RTB_CONFIG_SVH__
`define __TSN_RTB_CONFIG_SVH__

//------------------------------------------------------------------------------
// Class: tsn_rtb_config
//
// Configuration object for MUX's RTB module.
//
//------------------------------------------------------------------------------
class tsn_rtb_config extends altuvm_rtb_config;

   //---------------------------------------------------------------------------
   // UVM field Item lists
   //---------------------------------------------------------------------------
   // DUT and TB parameter lists
   `TSN_RTB_PARAM_DEFCFG
   tsn_pkg::device_e   E_DEVICE_FAMILY;
   ...
   //---------------------------------------------------------------------------
   `uvm_object_utils_begin(tsn_rtb_config)
      `TSN_RTB_PARAM_DEFUVM
      `uvm_field_enum(tsn_pkg::device_e, E_DEVICE_FAMILY, UVM_PRINT)
...
*/
   ...
   //
   function new(string name = "tsn_rtb_config");
      super.new(name);
...
endclass : tsn_rtb_config

`endif//__TSN_RTB_CONFIG_SVH__
