...
// agreement for further details.
 ...
 //class logical_channel_number_urm  extends uvm_reg; 
 // 
 //      `uvm_object_utils(logical_channel_number_urm  ) 
 // 
 //      rand uvm_reg_field logical_channel_number; 
 // 
 //      // Constructor 
 //      function new(string name = "logical_channel_number_urm"); 
 ...
 //         // create bitfield   
 //         logical_channel_number = uvm_reg_field::type_id::create("logical_channel_number"); 
 //         // configure 
 //         logical_channel_number.configure( 
 //         .parent                 ( this ), 
 //         .size                   (32), 
 //         .lsb_pos                (0), 
 //         .access                 ("RW"), 
...
// endclass : logical_channel_number_urm 
 
// class control_urm  extends uvm_reg; 
//  
//       `uvm_object_utils(control_urm  ) 
//  
//       rand uvm_reg_field SPEED_SELECT1; 
//       rand uvm_reg_field SPEED_SELECT2; 
//       rand uvm_reg_field Reserved; 
//       rand uvm_reg_field RECONFIG_START; 
//       rand uvm_reg_field Reserved; 
//  
//       // Constructor 
//       function new(string name = "control_urm"); 
//          super.new(name,32,build_coverage(UVM_CVR_FIELD_VALS)); 
//        
//       endfunction : new 
//  
...
//       virtual function void build(); 
//          // create bitfield   
//          SPEED_SELECT1 = uvm_reg_field::type_id::create("SPEED_SELECT1"); 
//          // configure 
//          SPEED_SELECT1.configure( 
//          .parent                 ( this ), 
//          .size                   (1), 
//          .lsb_pos                (0), 
//          .access                 ("RW"), 
...
//          .individually_accessible(0)); 
//           
//          SPEED_SELECT2 = uvm_reg_field::type_id::create("SPEED_SELECT2"); 
//           
//          SPEED_SELECT2.configure( 
//          .parent                 ( this ), 
//          .size                   (1), 
//          .lsb_pos                (1), 
//          .access                 ("RW"), 
...
//          .individually_accessible(0)); 
//          
//	  RECONFIG_START = uvm_reg_field::type_id::create("RECONFIG_START"); 
//          // configure 
//          RECONFIG_START.configure( 
//          .parent                 ( this ), 
//          .size                   (1), 
//          .lsb_pos                (16), 
//          .access                 ("WRC"), 
...
//  
//     
// endclass : control_urm 
//
// class status_urm  extends uvm_reg; 
//  
//       `uvm_object_utils(status_urm  ) 
//  
//       rand uvm_reg_field RECONFIG_BUSY; 
//       rand uvm_reg_field Reserved; 
//  
//       // Constructor 
//       function new(string name = "status_urm"); 
//          super.new(name,32,build_coverage(UVM_CVR_FIELD_VALS)); 
//        
//       endfunction : new 
//  
...
//       virtual function void build(); 
//          // create bitfield   
//          RECONFIG_BUSY = uvm_reg_field::type_id::create("RECONFIG_BUSY"); 
//          // configure 
//          RECONFIG_BUSY.configure( 
//          .parent                 ( this ), 
//          .size                   (1), 
//          .lsb_pos                (0), 
//          .access                 ("RO"), 
...
// endclass : status_urm 
 ...
 class sgmii_control_urm  extends uvm_reg; 
  
       `uvm_object_utils(sgmii_control_urm  ) 
  
       rand uvm_reg_field Reset; 
       rand uvm_reg_field PHY_LOOPBACK; 
       rand uvm_reg_field SGMII_SPEED; 
       rand uvm_reg_field AN_ENABLE; 
       rand uvm_reg_field POWER_DOWN; 
       rand uvm_reg_field ISOLATE; 
       rand uvm_reg_field RESTART_AN; 
       rand uvm_reg_field DUPLEX_MODE; 
       rand uvm_reg_field COLLISION_TEST; 
       rand uvm_reg_field SGMII_SPEED; 
       rand uvm_reg_field UNIDIR_EN; 
       rand uvm_reg_field Reserved; 
  
       // Constructor 
       function new(string name = "sgmii_control_urm"); 
          super.new(name,32,build_coverage(UVM_CVR_FIELD_VALS)); 
       ...
       virtual function void build(); 
          ...
          PHY_LOOPBACK = uvm_reg_field::type_id::create("PHY_LOOPBACK"); 
          // configure 
          PHY_LOOPBACK.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (14), 
          .access                 ("RW"), 
          ...
          SGMII_SPEED = uvm_reg_field::type_id::create("SGMII_SPEED"); 
          // configure 
          SGMII_SPEED.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (13), 
          .access                 ("RO"), 
          ...
          AN_ENABLE = uvm_reg_field::type_id::create("AN_ENABLE"); 
          // configure 
          AN_ENABLE.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          ...
          POWER_DOWN = uvm_reg_field::type_id::create("POWER_DOWN"); 
          // configure 
          POWER_DOWN.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (11), 
          .access                 ("RW"), 
          ...
          ISOLATE = uvm_reg_field::type_id::create("ISOLATE"); 
          // configure 
          ISOLATE.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          ...
          DUPLEX_MODE = uvm_reg_field::type_id::create("DUPLEX_MODE"); 
          // configure 
          DUPLEX_MODE.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (8), 
          .access                 ("RO"), 
          ...
          COLLISION_TEST = uvm_reg_field::type_id::create("COLLISION_TEST"); 
          // configure 
          COLLISION_TEST.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (7), 
          .access                 ("RO"), 
 ...
 endclass : sgmii_control_urm 
 
// ---------------------------
 class sgmii_status_urm  extends uvm_reg; 
  
       `uvm_object_utils(sgmii_status_urm  ) 
  
       rand uvm_reg_field STATUS_100BASE_T4; 
       rand uvm_reg_field FULL_DUPLEX_100BASEX; 
       rand uvm_reg_field HALF_DUPLEX_100BASEX; 
       rand uvm_reg_field FULL_DUPLEX_10MBPS; 
       rand uvm_reg_field HALF_DUPLEX_10MBPS; 
       rand uvm_reg_field FULL_DUPLEX_100BASET2; 
       rand uvm_reg_field HALF_DUPLEX_100BASET2; 
       rand uvm_reg_field Reserved; 
       rand uvm_reg_field UNIDIRECTIONAL_ABILITY; 
       rand uvm_reg_field Reserved; 
       rand uvm_reg_field AN_COMPLETE; 
       rand uvm_reg_field Reserved; 
       rand uvm_reg_field AN_ABILITY; 
       rand uvm_reg_field LINK_STATUS; 
       rand uvm_reg_field Reserved; 
       rand uvm_reg_field EXTENDED_CAPABILITY; 
  
       // Constructor 
       function new(string name = "sgmii_status_urm"); 
          super.new(name,32,build_coverage(UVM_CVR_FIELD_VALS)); 
       ...
       virtual function void build(); 
          // create bitfield   
          STATUS_100BASE_T4 = uvm_reg_field::type_id::create("STATUS_100BASE_T4"); 
          // configure 
          STATUS_100BASE_T4.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (15), 
          .access                 ("RO"), 
          ...
          FULL_DUPLEX_100BASEX = uvm_reg_field::type_id::create("FULL_DUPLEX_100BASEX"); 
          // configure 
          FULL_DUPLEX_100BASEX.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (14), 
          .access                 ("RO"), 
          ...
          HALF_DUPLEX_100BASEX = uvm_reg_field::type_id::create("HALF_DUPLEX_100BASEX"); 
          // configure 
          HALF_DUPLEX_100BASEX.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (13), 
          .access                 ("RO"), 
          ...
          FULL_DUPLEX_10MBPS = uvm_reg_field::type_id::create("FULL_DUPLEX_10MBPS"); 
          // configure 
          FULL_DUPLEX_10MBPS.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (12), 
          .access                 ("RO"), 
          ...
          HALF_DUPLEX_10MBPS = uvm_reg_field::type_id::create("HALF_DUPLEX_10MBPS"); 
          // configure 
          HALF_DUPLEX_10MBPS.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (11), 
          .access                 ("RO"), 
          ...
          FULL_DUPLEX_100BASET2 = uvm_reg_field::type_id::create("FULL_DUPLEX_100BASET2"); 
          // configure 
          FULL_DUPLEX_100BASET2.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (10), 
          .access                 ("RO"), 
          ...
          .individually_accessible(0)); 
           ...
           HALF_DUPLEX_100BASET2 = uvm_reg_field::type_id::create("HALF_DUPLEX_100BASET2"); 
          // configure 
           HALF_DUPLEX_100BASET2.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (9), 
          .access                 ("RO"), 
          ...
          UNIDIRECTIONAL_ABILITY = uvm_reg_field::type_id::create("UNIDIRECTIONAL_ABILITY"); 
          // configure 
          UNIDIRECTIONAL_ABILITY.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (7), 
          .access                 ("RO"), 
          ...
          AN_ABILITY = uvm_reg_field::type_id::create("AN_ABILITY"); 
          // configure 
          AN_ABILITY.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (3), 
          .access                 ("RO"), 
          ...
          EXTENDED_CAPABILITY = uvm_reg_field::type_id::create("EXTENDED_CAPABILITY"); 
          // configure 
          EXTENDED_CAPABILITY.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (0), 
          .access                 ("RO"), 
 ...
 endclass : sgmii_status_urm 
 
// ---------------------------
 class phy_id_reg0_urm  extends uvm_reg; 
  
       `uvm_object_utils(phy_id_reg0_urm  ) 
  
       rand uvm_reg_field phy_id_reg0; 
  
       // Constructor 
       function new(string name = "phy_id_reg0_urm"); 
          super.new(name,32,build_coverage(UVM_CVR_FIELD_VALS)); 
       ...
       virtual function void build(); 
          // create bitfield   
          phy_id_reg0 = uvm_reg_field::type_id::create("phy_id_reg0"); 
          // configure 
          phy_id_reg0.configure( 
          .parent                 ( this ), 
          .size                   (16), 
          .lsb_pos                (16), 
          .access                 ("RO"), 
 ...
 endclass : phy_id_reg0_urm 
 
// ---------------------------
 class phy_id_reg1_urm  extends uvm_reg; 
  
       `uvm_object_utils(phy_id_reg1_urm  ) 
  
       rand uvm_reg_field phy_id_reg1; 
  
       // Constructor 
       function new(string name = "phy_id_reg1_urm"); 
          super.new(name,32,build_coverage(UVM_CVR_FIELD_VALS)); 
       ...
       virtual function void build(); 
          // create bitfield   
          phy_id_reg1 = uvm_reg_field::type_id::create("phy_id_reg1"); 
          // configure 
          phy_id_reg1.configure( 
          .parent                 ( this ), 
          .size                   (16), 
          .lsb_pos                (0), 
          .access                 ("RO"), 
 ...
 endclass : phy_id_reg1_urm 
 
// ---------------------------
 class sgmii_dev_ability_urm  extends uvm_reg; 
  
       `uvm_object_utils(sgmii_dev_ability_urm  ) 
  
       rand uvm_reg_field NEXT_PAGE; 
       rand uvm_reg_field ACK; 
       rand uvm_reg_field REMOTE_FAULT2; 
       rand uvm_reg_field REMOTE_FAULT1; 
       rand uvm_reg_field Reserved ; 
       rand uvm_reg_field PAUSE_SUPPORT2; 
       rand uvm_reg_field PAUSE_SUPPORT2; 
       rand uvm_reg_field HALF_DUPLEX_MODE; 
       rand uvm_reg_field FULL_DUPLEX_MODE; 
       rand uvm_reg_field Reserved; 
  
       // Constructor 
       function new(string name = "sgmii_dev_ability_urm"); 
          super.new(name,32,build_coverage(UVM_CVR_FIELD_VALS)); 
       ...
       virtual function void build(); 
          // create bitfield   
          NEXT_PAGE = uvm_reg_field::type_id::create("NEXT_PAGE"); 
          // configure 
          NEXT_PAGE.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          ...
          REMOTE_FAULT2 = uvm_reg_field::type_id::create("REMOTE_FAULT2"); 
          // configure 
          REMOTE_FAULT2.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (13), 
          .access                 ("RO"), 
          ...
          REMOTE_FAULT1 = uvm_reg_field::type_id::create("REMOTE_FAULT1"); 
          // configure 
          REMOTE_FAULT1.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (12), 
          .access                 ("RO"), 
          ...
          PAUSE_SUPPORT2 = uvm_reg_field::type_id::create("PAUSE_SUPPORT2"); 
          // configure 
          PAUSE_SUPPORT2.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (8), 
          .access                 ("RW"), 
          ...
          HALF_DUPLEX_MODE = uvm_reg_field::type_id::create("HALF_DUPLEX_MODE"); 
          // configure 
          HALF_DUPLEX_MODE.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (6), 
          .access                 ("RW"), 
          ...
          FULL_DUPLEX_MODE = uvm_reg_field::type_id::create("FULL_DUPLEX_MODE"); 
          // configure 
          FULL_DUPLEX_MODE.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (5), 
          .access                 ("RW"), 
 ...
 endclass : sgmii_dev_ability_urm 
 
// ---------------------------
 class sgmii_partner_ability_urm  extends uvm_reg; 
  
       `uvm_object_utils(sgmii_partner_ability_urm  ) 
       ...
       // Constructor 
       function new(string name = "sgmii_partner_ability_urm"); 
          super.new(name,32,build_coverage(UVM_CVR_FIELD_VALS)); 
 ...
 endclass : sgmii_partner_ability_urm 
 
// ---------------------------
 class an_expansion_urm  extends uvm_reg; 
  
       `uvm_object_utils(an_expansion_urm  ) 
  
       rand uvm_reg_field Reserved; 
       rand uvm_reg_field Reserved; 
       rand uvm_reg_field page_received; 
       rand uvm_reg_field Link_partner_an_enable; 
  
       // Constructor 
       function new(string name = "an_expansion_urm"); 
          super.new(name,32,build_coverage(UVM_CVR_FIELD_VALS)); 
       ...
       virtual function void build(); 
          ...
          page_received = uvm_reg_field::type_id::create("page_received"); 
          // configure 
          page_received.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (1), 
          .access                 ("RO"), 
          ...
          Link_partner_an_enable = uvm_reg_field::type_id::create("Link_partner_an_enable"); 
          // configure 
          Link_partner_an_enable.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (0), 
          .access                 ("RO"), 
 ...
 endclass : an_expansion_urm 
 
// ---------------------------
 class device_nxt_page_urm  extends uvm_reg; 
  
       `uvm_object_utils(device_nxt_page_urm  ) 
  
       rand uvm_reg_field device_nxt_page; 
  
       // Constructor 
       function new(string name = "device_nxt_page_urm"); 
          super.new(name,32,build_coverage(UVM_CVR_FIELD_VALS)); 
       ...
       virtual function void build(); 
          // create bitfield   
          device_nxt_page = uvm_reg_field::type_id::create("device_nxt_page"); 
          // configure 
          device_nxt_page.configure( 
          .parent                 ( this ), 
          .size                   (32), 
          .lsb_pos                (0), 
          .access                 ("RO"), 
 ...
 endclass : device_nxt_page_urm 
 
// ---------------------------
 class partner_nxt_page_urm  extends uvm_reg; 
  
       `uvm_object_utils(partner_nxt_page_urm  ) 
  
       rand uvm_reg_field partner_nxt_page; 
  
       // Constructor 
       function new(string name = "partner_nxt_page_urm"); 
          super.new(name,32,build_coverage(UVM_CVR_FIELD_VALS)); 
       ...
       virtual function void build(); 
          // create bitfield   
          partner_nxt_page = uvm_reg_field::type_id::create("partner_nxt_page"); 
          // configure 
          partner_nxt_page.configure( 
          .parent                 ( this ), 
          .size                   (2), 
          .lsb_pos                (0), 
          .access                 ("RO"), 
 ...
 endclass : partner_nxt_page_urm 
 
// ---------------------------
 
// ---------------------------
 class pcs_scratch_urm  extends uvm_reg; 
  
       `uvm_object_utils(pcs_scratch_urm  ) 
  
       rand uvm_reg_field pcs_scratch; 
  
       // Constructor 
       function new(string name = "pcs_scratch_urm"); 
          super.new(name,32,build_coverage(UVM_CVR_FIELD_VALS)); 
       ...
       virtual function void build(); 
          // create bitfield   
          pcs_scratch = uvm_reg_field::type_id::create("pcs_scratch"); 
          // configure 
          pcs_scratch.configure( 
          .parent                 ( this ), 
          .size                   (16),
          .lsb_pos                (0), 
          .access                 ("RW"), 
 ...
 endclass : pcs_scratch_urm 
 
// ---------------------------
 
// ---------------------------
 class an_link_timer0_lo_urm  extends uvm_reg; 
  
       `uvm_object_utils(an_link_timer0_lo_urm  ) 
  
       rand uvm_reg_field Reserved; 
       rand uvm_reg_field an_link_timer0; 
       rand uvm_reg_field Reserved; 
  
       // Constructor 
       function new(string name = "an_link_timer0_lo_urm"); 
          super.new(name,32,build_coverage(UVM_CVR_FIELD_VALS)); 
       ...
       virtual function void build(); 
          ...
          an_link_timer0 = uvm_reg_field::type_id::create("an_link_timer0"); 
          // configure 
          an_link_timer0.configure( 
          .parent                 ( this ), 
          .size                   (15), 
          .lsb_pos                (1), 
          .access                 ("RW"), 
          .volatile               (1), 
          .reset                  (15'b100010010110100), 
          .has_reset              (1), 
          .is_rand                (1), 
          .individually_accessible(0)); 
 ...
 endclass : an_link_timer0_lo_urm 
 
// ---------------------------
 class an_link_timer0_hi_urm  extends uvm_reg; 
  
       `uvm_object_utils(an_link_timer0_hi_urm  ) 
  
       rand uvm_reg_field Reserved; 
       rand uvm_reg_field an_link_timer1; 
       //rand uvm_reg_field Reserved; 
  
       // Constructor 
       function new(string name = "an_link_timer0_hi_urm"); 
          super.new(name,32,build_coverage(UVM_CVR_FIELD_VALS)); 
       ...
       virtual function void build(); 
          ...
          an_link_timer1 = uvm_reg_field::type_id::create("an_link_timer1"); 
          // configure 
          an_link_timer1.configure( 
          .parent                 ( this ), 
          .size                   (5), 
          .lsb_pos                (0),
          .access                 ("RW"), 
 ...
 endclass : an_link_timer0_hi_urm 
 
// ---------------------------
 class if_mode_urm  extends uvm_reg; 
  
       `uvm_object_utils(if_mode_urm  ) 
  
       rand uvm_reg_field Reserved; 
       rand uvm_reg_field SGMII_AN_MODE; 
       rand uvm_reg_field SGMII_DUPLEX; 
       rand uvm_reg_field SGMII_SPEED1; 
       rand uvm_reg_field SGMII_SPEED0; 
       rand uvm_reg_field USE_SGMII_AN; 
       rand uvm_reg_field SGMII_ENA; 
  
       // Constructor 
       function new(string name = "if_mode_urm"); 
          super.new(name,32,build_coverage(UVM_CVR_FIELD_VALS)); 
       ...
       virtual function void build(); 
          ...
          SGMII_AN_MODE = uvm_reg_field::type_id::create("SGMII_AN_MODE"); 
          // configure 
          SGMII_AN_MODE.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (5), 
          .access                 ("RW"), 
          ...
          SGMII_DUPLEX = uvm_reg_field::type_id::create("SGMII_DUPLEX"); 
          // configure 
          SGMII_DUPLEX.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (4), 
          .access                 ("RW"), 
          ...
          SGMII_SPEED1 = uvm_reg_field::type_id::create("SGMII_SPEED1"); 
          // configure 
          SGMII_SPEED1.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (3), 
          .access                 ("RW"), 
          ...
          SGMII_SPEED0 = uvm_reg_field::type_id::create("SGMII_SPEED0"); 
          // configure 
          SGMII_SPEED0.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (2), 
          .access                 ("RW"), 
          ...
          USE_SGMII_AN = uvm_reg_field::type_id::create("USE_SGMII_AN"); 
          // configure 
          USE_SGMII_AN.configure( 
          .parent                 ( this ), 
          .size                   (1), 
          .lsb_pos                (1), 
          .access                 ("RW"), 
          ...
          SGMII_ENA = uvm_reg_field::type_id::create("SGMII_ENA"); 
          // configure 
          SGMII_ENA.configure( 
          .parent                 ( this ), 
          .size                   (1), 
 ...
 class registers_urm  extends  uvm_reg_block;
       ...
       //rand logical_channel_number_urm logical_channel_number;
       //rand control_urm control;
       //rand status_urm status;
       ...
       rand sgmii_control_urm sgmii_control;
       rand sgmii_status_urm sgmii_status;
       rand phy_id_reg0_urm phy_id_reg0;
       rand phy_id_reg1_urm phy_id_reg1;
       rand sgmii_dev_ability_urm sgmii_dev_ability;
       rand sgmii_partner_ability_urm sgmii_partner_ability;
       rand an_expansion_urm an_expansion;
       rand device_nxt_page_urm device_nxt_page;
       rand partner_nxt_page_urm partner_nxt_page;
       rand pcs_scratch_urm pcs_scratch;
       rand an_link_timer0_lo_urm an_link_timer0_lo;
       rand an_link_timer0_hi_urm an_link_timer0_hi;
       rand if_mode_urm if_mode;
       ...
       virtual function void build();
          ...
          // Create registers
        //  logical_channel_number = logical_channel_number_urm::type_id::create("logical_channel_number");
        //  logical_channel_number.configure(this,null,"");
        //  logical_channel_number.build();
        //  
        //  control = control_urm::type_id::create("control");
        //  control.configure(this,null,"");
        //  control.build();
        //  
        //  status = status_urm::type_id::create("status");
	  ...
	  sgmii_control = sgmii_control_urm::type_id::create("sgmii_control");
          sgmii_control.configure(this,null,"");
          sgmii_control.build();
          
          sgmii_status = sgmii_status_urm::type_id::create("sgmii_status");
          sgmii_status.configure(this,null,"");
          sgmii_status.build();
          
          phy_id_reg0 = phy_id_reg0_urm::type_id::create("phy_id_reg0");
          phy_id_reg0.configure(this,null,"");
          phy_id_reg0.build();
          
          phy_id_reg1 = phy_id_reg1_urm::type_id::create("phy_id_reg1");
          phy_id_reg1.configure(this,null,"");
          phy_id_reg1.build();
          
          sgmii_dev_ability = sgmii_dev_ability_urm::type_id::create("sgmii_dev_ability");
          sgmii_dev_ability.configure(this,null,"");
          sgmii_dev_ability.build();
          
          sgmii_partner_ability = sgmii_partner_ability_urm::type_id::create("sgmii_partner_ability");
          sgmii_partner_ability.configure(this,null,"");
          sgmii_partner_ability.build();
          
          an_expansion = an_expansion_urm::type_id::create("an_expansion");
          an_expansion.configure(this,null,"");
          an_expansion.build();
          
          device_nxt_page = device_nxt_page_urm::type_id::create("device_nxt_page");
          device_nxt_page.configure(this,null,"");
          device_nxt_page.build();
          
          partner_nxt_page = partner_nxt_page_urm::type_id::create("partner_nxt_page");
          partner_nxt_page.configure(this,null,"");
          partner_nxt_page.build();
          
          
          pcs_scratch = pcs_scratch_urm::type_id::create("pcs_scratch");
          pcs_scratch.configure(this,null,"");
          pcs_scratch.build();
          
          an_link_timer0_lo = an_link_timer0_lo_urm::type_id::create("an_link_timer0_lo");
          an_link_timer0_lo.configure(this,null,"");
          an_link_timer0_lo.build();
          
          an_link_timer0_hi = an_link_timer0_hi_urm::type_id::create("an_link_timer0_hi");
          an_link_timer0_hi.configure(this,null,"");
          an_link_timer0_hi.build();
          
          if_mode = if_mode_urm::type_id::create("if_mode");
          if_mode.configure(this,null,"");
          if_mode.build();
          ...
          //mapping
          //this.default_map.add_reg(logical_channel_number, `UVM_REG_ADDR_WIDTH'h0000, "RW");
          //this.default_map.add_reg(control, `UVM_REG_ADDR_WIDTH'h4001, "RW");
          //this.default_map.add_reg(status, `UVM_REG_ADDR_WIDTH'h4002, "RO");


          this.default_map.add_reg(tx_packet_control, `UVM_REG_ADDR_WIDTH'h1000, "RW");
          this.default_map.add_reg(tx_transfer_status, `UVM_REG_ADDR_WIDTH'h1001, "RO");
          this.default_map.add_reg(tx_pad_control, `UVM_REG_ADDR_WIDTH'h1040, "RW");
          this.default_map.add_reg(tx_crc_control, `UVM_REG_ADDR_WIDTH'h1080, "RW");
          this.default_map.add_reg(tx_preamble_control, `UVM_REG_ADDR_WIDTH'h1100, "RO");//updated access from RW to RO because register will update only when passthrough preamble is 1
          this.default_map.add_reg(tx_unidir_control, `UVM_REG_ADDR_WIDTH'h1120, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(tx_underflow_counter0, `UVM_REG_ADDR_WIDTH'h10C0, "RO");
          this.default_map.add_reg(tx_underflow_counter1, `UVM_REG_ADDR_WIDTH'h10C1, "RO");
          this.default_map.add_reg(tx_pauseframe_control, `UVM_REG_ADDR_WIDTH'h1140, "RW");
          this.default_map.add_reg(mac_cfg_tx_pause_quanta, `UVM_REG_ADDR_WIDTH'h1141, "RW");
          this.default_map.add_reg(tx_pauseframe_enable, `UVM_REG_ADDR_WIDTH'h1142, "RW");
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_0, `UVM_REG_ADDR_WIDTH'h1180, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_1, `UVM_REG_ADDR_WIDTH'h1181, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_2, `UVM_REG_ADDR_WIDTH'h1182, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_3, `UVM_REG_ADDR_WIDTH'h1183, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_4, `UVM_REG_ADDR_WIDTH'h1184, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_5, `UVM_REG_ADDR_WIDTH'h1185, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_6, `UVM_REG_ADDR_WIDTH'h1186, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_7, `UVM_REG_ADDR_WIDTH'h1187, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_0, `UVM_REG_ADDR_WIDTH'h1190, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_1, `UVM_REG_ADDR_WIDTH'h1191, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_2, `UVM_REG_ADDR_WIDTH'h1192, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_3, `UVM_REG_ADDR_WIDTH'h1193, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_4, `UVM_REG_ADDR_WIDTH'h1194, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_5, `UVM_REG_ADDR_WIDTH'h1195, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_6, `UVM_REG_ADDR_WIDTH'h1196, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_7, `UVM_REG_ADDR_WIDTH'h1197, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(tx_pfc_priority_enable, `UVM_REG_ADDR_WIDTH'h11A0, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(tx_src_addr_override, `UVM_REG_ADDR_WIDTH'h1200, "RW");
          this.default_map.add_reg(mac_cfg_txmac_saddrl, `UVM_REG_ADDR_WIDTH'h1201, "RW");
          this.default_map.add_reg(mac_cfg_txmac_saddrh, `UVM_REG_ADDR_WIDTH'h1202, "RW");
          this.default_map.add_reg(mac_cfg_max_tx_size_config, `UVM_REG_ADDR_WIDTH'h1801, "RW");
          this.default_map.add_reg(tx_vlan_detection, `UVM_REG_ADDR_WIDTH'h1830, "RW");



          this.default_map.add_reg(rx_transfer_control, `UVM_REG_ADDR_WIDTH'h0000, "RW");
          this.default_map.add_reg(rx_transfer_status, `UVM_REG_ADDR_WIDTH'h0001, "RO");
          this.default_map.add_reg(rx_padcrc_control, `UVM_REG_ADDR_WIDTH'h0040, "RW");
          this.default_map.add_reg(rx_crccheck_control, `UVM_REG_ADDR_WIDTH'h0080, "RW");
          this.default_map.add_reg(rx_pktovrflow_error0, `UVM_REG_ADDR_WIDTH'h00C0, "RO");
          this.default_map.add_reg(rx_pktovrflow_error1, `UVM_REG_ADDR_WIDTH'h00C1, "RO");
          this.default_map.add_reg(rx_pktovrflow_etherStatsDropEvents0, `UVM_REG_ADDR_WIDTH'h00C2, "RO");
          this.default_map.add_reg(rx_pktovrflow_etherStatsDropEvents1, `UVM_REG_ADDR_WIDTH'h00C3, "RO");
          this.default_map.add_reg(rx_custom_preamble_forward, `UVM_REG_ADDR_WIDTH'h0100, "RO");//updated access from RW to RO because register will update only when passthrough preamble is 1
          this.default_map.add_reg(rx_preamble_control, `UVM_REG_ADDR_WIDTH'h0140, "RO");//updated access from RW to RO because register will update only when passthrough preamble is 1
          this.default_map.add_reg(rx_frame_control, `UVM_REG_ADDR_WIDTH'h0800, "RW");
          this.default_map.add_reg(mac_cfg_max_rx_size_config, `UVM_REG_ADDR_WIDTH'h0801, "RW");
;
          this.default_map.add_reg(rx_frame_spaddr0_0, `UVM_REG_ADDR_WIDTH'h0804, "RW");
          this.default_map.add_reg(rx_frame_spaddr0_1, `UVM_REG_ADDR_WIDTH'h0805, "RW");
          this.default_map.add_reg(rx_frame_spaddr1_0, `UVM_REG_ADDR_WIDTH'h0806, "RW");
          this.default_map.add_reg(rx_frame_spaddr1_1, `UVM_REG_ADDR_WIDTH'h0807, "RW");
          this.default_map.add_reg(rx_frame_spaddr2_0, `UVM_REG_ADDR_WIDTH'h0808, "RW");
          this.default_map.add_reg(rx_frame_spaddr2_1, `UVM_REG_ADDR_WIDTH'h0809, "RW");
          this.default_map.add_reg(rx_frame_spaddr3_0, `UVM_REG_ADDR_WIDTH'h080A, "RW");
          this.default_map.add_reg(rx_frame_spaddr3_1, `UVM_REG_ADDR_WIDTH'h080B, "RW");
          this.default_map.add_reg(rx_pfc_control, `UVM_REG_ADDR_WIDTH'h0818, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(rx_vlan_detection, `UVM_REG_ADDR_WIDTH'h0830, "RW");


          this.default_map.add_reg(tx_stats_clr, `UVM_REG_ADDR_WIDTH'h1C00, "WRC");
          this.default_map.add_reg(tx_stats_framesOK0, `UVM_REG_ADDR_WIDTH'h1C02, "RO");
          this.default_map.add_reg(tx_stats_framesOK1, `UVM_REG_ADDR_WIDTH'h1C03, "RO");
          this.default_map.add_reg(tx_stats_framesErr0, `UVM_REG_ADDR_WIDTH'h1C04, "RO");
          this.default_map.add_reg(tx_stats_framesErr1, `UVM_REG_ADDR_WIDTH'h1C05, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_payloadoctetsok_lo, `UVM_REG_ADDR_WIDTH'h1C08, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_payloadoctetsok_hi, `UVM_REG_ADDR_WIDTH'h1C09, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_pause_lo, `UVM_REG_ADDR_WIDTH'h1C0A, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_pause_hi, `UVM_REG_ADDR_WIDTH'h1C0B, "RO");
          this.default_map.add_reg(tx_stats_ifErrors0, `UVM_REG_ADDR_WIDTH'h1C0C, "RO");
          this.default_map.add_reg(tx_stats_ifErrors1, `UVM_REG_ADDR_WIDTH'h1C0D, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_ucast_data_ok_lo, `UVM_REG_ADDR_WIDTH'h1C0E, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_ucast_data_ok_hi, `UVM_REG_ADDR_WIDTH'h1C0F, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_utcast_data_err_lo, `UVM_REG_ADDR_WIDTH'h1C10, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_utcast_data_err_hi, `UVM_REG_ADDR_WIDTH'h1C11, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_mcast_data_ok_lo, `UVM_REG_ADDR_WIDTH'h1C12, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_mcast_data_ok_hi, `UVM_REG_ADDR_WIDTH'h1C13, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_mcast_data_err_lo, `UVM_REG_ADDR_WIDTH'h1c14, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_mcast_data_err_hi, `UVM_REG_ADDR_WIDTH'h1155, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_bcast_data_ok_lo, `UVM_REG_ADDR_WIDTH'h1C16, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_bcast_data_ok_hi, `UVM_REG_ADDR_WIDTH'h1C17, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_bcast_data_err_lo, `UVM_REG_ADDR_WIDTH'h1C18, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_bcast_data_err_hi, `UVM_REG_ADDR_WIDTH'h1C19, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_octetsok_lo, `UVM_REG_ADDR_WIDTH'h1C1A, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_octetsok_hi, `UVM_REG_ADDR_WIDTH'h1C1B, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_st_lo, `UVM_REG_ADDR_WIDTH'h1C1C, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_st_hi, `UVM_REG_ADDR_WIDTH'h1C1D, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_runt_lo, `UVM_REG_ADDR_WIDTH'h1C1E, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_runt_hi, `UVM_REG_ADDR_WIDTH'h1C1F, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_oversize_lo, `UVM_REG_ADDR_WIDTH'h1C20, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_oversize_hi, `UVM_REG_ADDR_WIDTH'h1C21, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_64b_lo, `UVM_REG_ADDR_WIDTH'h1C22, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_64b_hi, `UVM_REG_ADDR_WIDTH'h1C23, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_65to127b_lo, `UVM_REG_ADDR_WIDTH'h1C24, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_65to127b_hi, `UVM_REG_ADDR_WIDTH'h1C25, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_128to255b_lo, `UVM_REG_ADDR_WIDTH'h1C26, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_128to255b_hi, `UVM_REG_ADDR_WIDTH'h1C27, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_256to511b_lo, `UVM_REG_ADDR_WIDTH'h1C28, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_256to511b_hi, `UVM_REG_ADDR_WIDTH'h1C29, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_512to1023b_lo, `UVM_REG_ADDR_WIDTH'h1C2A, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_512to1023b_hi, `UVM_REG_ADDR_WIDTH'h1C2B, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_1024to1518b_lo, `UVM_REG_ADDR_WIDTH'h1C2C, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_1024to1518b_hi, `UVM_REG_ADDR_WIDTH'h1C2D, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_1519tomaxb_lo, `UVM_REG_ADDR_WIDTH'h1C2E, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_1519tomaxb_hi, `UVM_REG_ADDR_WIDTH'h1C2F, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_ucast_ctrl_lo, `UVM_REG_ADDR_WIDTH'h1C36, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_ucast_ctrl_hi, `UVM_REG_ADDR_WIDTH'h1C37, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_mcast_ctrl_lo, `UVM_REG_ADDR_WIDTH'h1C38, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_mcast_ctrl_hi, `UVM_REG_ADDR_WIDTH'h1C39, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_bcast_ctrl_lo, `UVM_REG_ADDR_WIDTH'h1C3A, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_bcast_ctrl_hi, `UVM_REG_ADDR_WIDTH'h1C3B, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_pfc_lo, `UVM_REG_ADDR_WIDTH'h1C3C, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_pfc_hi, `UVM_REG_ADDR_WIDTH'h1C3D, "RO");
          this.default_map.add_reg(rx_stats_clr, `UVM_REG_ADDR_WIDTH'h0C00, "WRC");
          this.default_map.add_reg(rx_stats_framesOK0, `UVM_REG_ADDR_WIDTH'h0C02, "RO");
          this.default_map.add_reg(rx_stats_framesOK1, `UVM_REG_ADDR_WIDTH'h0C03, "RO");
          this.default_map.add_reg(rx_stats_framesErr0, `UVM_REG_ADDR_WIDTH'h0C04, "RO");
          this.default_map.add_reg(rx_stats_framesErr1, `UVM_REG_ADDR_WIDTH'h0C05, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_fcs_lo, `UVM_REG_ADDR_WIDTH'h0C06, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_fcs_hi, `UVM_REG_ADDR_WIDTH'h0C07, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_payloadoctetsok_lo, `UVM_REG_ADDR_WIDTH'h0C08, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_payloadoctetsok_hi, `UVM_REG_ADDR_WIDTH'h0C09, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_pause_lo, `UVM_REG_ADDR_WIDTH'h0C0A, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_pause_hi, `UVM_REG_ADDR_WIDTH'h0C0B, "RO");
          this.default_map.add_reg(rx_stats_ifErrors0, `UVM_REG_ADDR_WIDTH'h0C0C, "RO");
          this.default_map.add_reg(rx_stats_ifErrors1, `UVM_REG_ADDR_WIDTH'h0C0D, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_ucast_data_ok_lo, `UVM_REG_ADDR_WIDTH'h0C0E, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_ucast_data_ok_hi, `UVM_REG_ADDR_WIDTH'h0C0F, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_ucast_data_err_lo, `UVM_REG_ADDR_WIDTH'h0C10, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_ucast_data_err_hi, `UVM_REG_ADDR_WIDTH'h0C11, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_mcast_data_ok_lo, `UVM_REG_ADDR_WIDTH'h0C12, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_mcast_data_ok_hi, `UVM_REG_ADDR_WIDTH'h0C13, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_mcast_data_err_lo, `UVM_REG_ADDR_WIDTH'h0C14, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_mcast_data_err_hi, `UVM_REG_ADDR_WIDTH'h0C15, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_bcast_data_ok_lo, `UVM_REG_ADDR_WIDTH'h0C16, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_bcast_data_ok_hi, `UVM_REG_ADDR_WIDTH'h0C17, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_bcast_data_err_lo, `UVM_REG_ADDR_WIDTH'h0C18, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_bcast_data_err_hi, `UVM_REG_ADDR_WIDTH'h0C19, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_octetsok_lo, `UVM_REG_ADDR_WIDTH'h0C1A, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_octetsok_hi, `UVM_REG_ADDR_WIDTH'h0C1B, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_st_lo, `UVM_REG_ADDR_WIDTH'h0C1C, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_st_hi, `UVM_REG_ADDR_WIDTH'h0C1D, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_runt_lo, `UVM_REG_ADDR_WIDTH'h0C1E, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_runt_hi, `UVM_REG_ADDR_WIDTH'h0C1F, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_oversize_lo, `UVM_REG_ADDR_WIDTH'h0C20, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_oversize_hi, `UVM_REG_ADDR_WIDTH'h0C21, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_64b_lo, `UVM_REG_ADDR_WIDTH'h0C22, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_64b_hi, `UVM_REG_ADDR_WIDTH'h0C23, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_65to127b_lo, `UVM_REG_ADDR_WIDTH'h0C24, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_65to127b_hi, `UVM_REG_ADDR_WIDTH'h0C25, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_128to255b_lo, `UVM_REG_ADDR_WIDTH'h0C26, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_128to255b_hi, `UVM_REG_ADDR_WIDTH'h0C27, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_256to511b_lo, `UVM_REG_ADDR_WIDTH'h0C28, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_256to511b_hi, `UVM_REG_ADDR_WIDTH'h0C29, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_512to1023b_lo, `UVM_REG_ADDR_WIDTH'h0C2A, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_512to1023b_hi, `UVM_REG_ADDR_WIDTH'h0C2B, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_1024to1518b_lo, `UVM_REG_ADDR_WIDTH'h0C2C, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_1024to1518b_hi, `UVM_REG_ADDR_WIDTH'h0C2D, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_1519tomaxb_lo, `UVM_REG_ADDR_WIDTH'h0C2E, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_1519tomaxb_hi, `UVM_REG_ADDR_WIDTH'h0C2F, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_fragments_lo, `UVM_REG_ADDR_WIDTH'h0C30, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_fragments_hi, `UVM_REG_ADDR_WIDTH'h0C31, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_jabbers_lo, `UVM_REG_ADDR_WIDTH'h0C32, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_jabbers_hi, `UVM_REG_ADDR_WIDTH'h0C33, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_fcs_err_okpkt_lo, `UVM_REG_ADDR_WIDTH'h0C34, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_fcs_err_okpkt_hi, `UVM_REG_ADDR_WIDTH'h0C35, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_ucast_ctrl_lo, `UVM_REG_ADDR_WIDTH'h0C36, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_ucast_ctrl_hi, `UVM_REG_ADDR_WIDTH'h0C37, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_mcast_ctrl_lo, `UVM_REG_ADDR_WIDTH'h0C38, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_mcast_ctrl_hi, `UVM_REG_ADDR_WIDTH'h0C39, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_bcast_ctrl_lo, `UVM_REG_ADDR_WIDTH'h0C3A, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_bcast_ctrl_hi, `UVM_REG_ADDR_WIDTH'h0C3B, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_pfc_lo, `UVM_REG_ADDR_WIDTH'h0C3C, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_pfc_hi, `UVM_REG_ADDR_WIDTH'h0C3D, "RO");
          this.default_map.add_reg(tx_ipg_10g, `UVM_REG_ADDR_WIDTH'h081E, "RW");
          this.default_map.add_reg(tx_ipg_10M_100M_1G, `UVM_REG_ADDR_WIDTH'h081F, "RW");
          this.default_map.add_reg(mac_cfg_retransmit_xoff_holdoff_quanta, `UVM_REG_ADDR_WIDTH'h081D, "RW");
          this.default_map.add_reg(mac_reset_control, `UVM_REG_ADDR_WIDTH'h08FF, "RW");

          this.default_map.add_reg(sgmii_control, `UVM_REG_ADDR_WIDTH'h6000, "RW");
          this.default_map.add_reg(sgmii_status, `UVM_REG_ADDR_WIDTH'h6001, "RO");
          this.default_map.add_reg(phy_id_reg0, `UVM_REG_ADDR_WIDTH'h6002, "RO");
          this.default_map.add_reg(phy_id_reg1, `UVM_REG_ADDR_WIDTH'h6003, "RO");
          this.default_map.add_reg(sgmii_dev_ability, `UVM_REG_ADDR_WIDTH'h6004, "RO");
          this.default_map.add_reg(sgmii_partner_ability, `UVM_REG_ADDR_WIDTH'h6005, "RO");
          this.default_map.add_reg(an_expansion, `UVM_REG_ADDR_WIDTH'h6006, "RO");
          this.default_map.add_reg(device_nxt_page, `UVM_REG_ADDR_WIDTH'h6007, "RO");
          this.default_map.add_reg(partner_nxt_page, `UVM_REG_ADDR_WIDTH'h6008, "RO");
          this.default_map.add_reg(pcs_scratch, `UVM_REG_ADDR_WIDTH'h6010, "RW");
          this.default_map.add_reg(an_link_timer0_lo, `UVM_REG_ADDR_WIDTH'h6012, "RW");
          this.default_map.add_reg(an_link_timer0_hi, `UVM_REG_ADDR_WIDTH'h6013, "RW");
          this.default_map.add_reg(if_mode, `UVM_REG_ADDR_WIDTH'h6014, "RW");
