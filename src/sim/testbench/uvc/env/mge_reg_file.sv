...
// agreement for further details.
 ...
 class logical_channel_number_urm  extends uvm_reg; 
       ...
       rand uvm_reg_field logical_number; 
       ...
       virtual function void build(); 
          // create bitfield   
          logical_number = uvm_reg_field::type_id::create("logical_number"); 
          // configure 
          logical_number.configure( 
          .parent                 ( this ), 
          .size                   (10), 
          .lsb_pos                (0), 
          .access                 ("RW"), 
 ...
 class control_urm  extends uvm_reg; 
       ...
       rand uvm_reg_field SPEED_SELECT; 
       rand uvm_reg_field Reserved; 
       ...
       virtual function void build(); 
          // create bitfield   
          SPEED_SELECT = uvm_reg_field::type_id::create("SPEED_SELECT"); 
          // configure 
          SPEED_SELECT.configure( 
          .parent                 ( this ), 
          .size                   (2), 
          .lsb_pos                (0), 
          .access                 ("RW"), 
...
// ---------------------------
 ...
 class registers_urm  extends  uvm_reg_block;
	  ...
	  sgmii_control = sgmii_control_urm::type_id::create("sgmii_control");
          ...
          this.default_map.add_reg(control, `UVM_REG_ADDR_WIDTH'h0001, "RW");
          this.default_map.add_reg(status, `UVM_REG_ADDR_WIDTH'h0002, "RO");
          this.default_map.add_reg(mac_cfg_txmac_saddrl, `UVM_REG_ADDR_WIDTH'h4010, "RW");
          this.default_map.add_reg(mac_cfg_txmac_saddrh, `UVM_REG_ADDR_WIDTH'h4011, "RW");
          this.default_map.add_reg(mac_reset_control, `UVM_REG_ADDR_WIDTH'h401F, "RW");
          this.default_map.add_reg(tx_packet_control, `UVM_REG_ADDR_WIDTH'h4020, "RW");
          this.default_map.add_reg(tx_transfer_status, `UVM_REG_ADDR_WIDTH'h4022, "RO");
          this.default_map.add_reg(tx_pad_control, `UVM_REG_ADDR_WIDTH'h4024, "RW");
          this.default_map.add_reg(tx_crc_control, `UVM_REG_ADDR_WIDTH'h4026, "RW");
          this.default_map.add_reg(tx_preamble_control, `UVM_REG_ADDR_WIDTH'h4028, "RO");//updated access from RW to RO because register will update only when passthrough preamble is 1
          this.default_map.add_reg(tx_src_addr_override, `UVM_REG_ADDR_WIDTH'h402A, "RW");
          this.default_map.add_reg(mac_cfg_max_tx_size_config, `UVM_REG_ADDR_WIDTH'h402C, "RW");
          this.default_map.add_reg(tx_vlan_detection, `UVM_REG_ADDR_WIDTH'h402D, "RW");
          this.default_map.add_reg(tx_ipg_10g, `UVM_REG_ADDR_WIDTH'h402E, "RW");
          this.default_map.add_reg(tx_ipg_10M_100M_1G, `UVM_REG_ADDR_WIDTH'h402F, "RW");
          this.default_map.add_reg(tx_underflow_counter0, `UVM_REG_ADDR_WIDTH'h403E, "RO");
          this.default_map.add_reg(tx_underflow_counter1, `UVM_REG_ADDR_WIDTH'h403F, "RO");
          this.default_map.add_reg(tx_pauseframe_control, `UVM_REG_ADDR_WIDTH'h4040, "RW");
          this.default_map.add_reg(mac_cfg_tx_pause_quanta, `UVM_REG_ADDR_WIDTH'h4042, "RW");
          this.default_map.add_reg(mac_cfg_retransmit_xoff_holdoff_quanta, `UVM_REG_ADDR_WIDTH'h4043, "RW");
          this.default_map.add_reg(tx_pauseframe_enable, `UVM_REG_ADDR_WIDTH'h4044, "RW");
          this.default_map.add_reg(tx_pfc_priority_enable, `UVM_REG_ADDR_WIDTH'h4046, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_0, `UVM_REG_ADDR_WIDTH'h4048, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_1, `UVM_REG_ADDR_WIDTH'h4049, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_2, `UVM_REG_ADDR_WIDTH'h404A, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_3, `UVM_REG_ADDR_WIDTH'h404B, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_4, `UVM_REG_ADDR_WIDTH'h404C, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_5, `UVM_REG_ADDR_WIDTH'h404D, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_6, `UVM_REG_ADDR_WIDTH'h404E, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_pause_quanta_7, `UVM_REG_ADDR_WIDTH'h404F, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_0, `UVM_REG_ADDR_WIDTH'h4058, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_1, `UVM_REG_ADDR_WIDTH'h4059, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_2, `UVM_REG_ADDR_WIDTH'h405A, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_3, `UVM_REG_ADDR_WIDTH'h405B, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_4, `UVM_REG_ADDR_WIDTH'h405C, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_5, `UVM_REG_ADDR_WIDTH'h405D, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_6, `UVM_REG_ADDR_WIDTH'h405E, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(mac_cfg_pfc_holdoff_quanta_7, `UVM_REG_ADDR_WIDTH'h405F, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(tx_unidir_control, `UVM_REG_ADDR_WIDTH'h4070, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(rx_transfer_control, `UVM_REG_ADDR_WIDTH'h40A0, "RW");
          this.default_map.add_reg(rx_transfer_status, `UVM_REG_ADDR_WIDTH'h40A2, "RO");
          this.default_map.add_reg(rx_padcrc_control, `UVM_REG_ADDR_WIDTH'h40A4, "RW");
          this.default_map.add_reg(rx_crccheck_control, `UVM_REG_ADDR_WIDTH'h40A6, "RW");
          this.default_map.add_reg(rx_custom_preamble_forward, `UVM_REG_ADDR_WIDTH'h40A8, "RO");//updated access from RW to RO because register will update only when passthrough preamble is 1
          this.default_map.add_reg(rx_preamble_control, `UVM_REG_ADDR_WIDTH'h40AA, "RO");//updated access from RW to RO because register will update only when passthrough preamble is 1
          this.default_map.add_reg(rx_frame_control, `UVM_REG_ADDR_WIDTH'h40AC, "RW");
          this.default_map.add_reg(mac_cfg_max_rx_size_config, `UVM_REG_ADDR_WIDTH'h40AE, "RW");
          this.default_map.add_reg(rx_vlan_detection, `UVM_REG_ADDR_WIDTH'h40AF, "RW");
          this.default_map.add_reg(rx_frame_spaddr0_0, `UVM_REG_ADDR_WIDTH'h40B0, "RW");
          this.default_map.add_reg(rx_frame_spaddr0_1, `UVM_REG_ADDR_WIDTH'h40B1, "RW");
          this.default_map.add_reg(rx_frame_spaddr1_0, `UVM_REG_ADDR_WIDTH'h40B2, "RW");
          this.default_map.add_reg(rx_frame_spaddr1_1, `UVM_REG_ADDR_WIDTH'h40B3, "RW");
          this.default_map.add_reg(rx_frame_spaddr2_0, `UVM_REG_ADDR_WIDTH'h40B4, "RW");
          this.default_map.add_reg(rx_frame_spaddr2_1, `UVM_REG_ADDR_WIDTH'h40B5, "RW");
          this.default_map.add_reg(rx_frame_spaddr3_0, `UVM_REG_ADDR_WIDTH'h40B6, "RW");
          this.default_map.add_reg(rx_frame_spaddr3_1, `UVM_REG_ADDR_WIDTH'h40B7, "RW");
          this.default_map.add_reg(rx_pfc_control, `UVM_REG_ADDR_WIDTH'h40C0, "RO");//updated access from RW to RO because these register is not enabled in these version of IP
          this.default_map.add_reg(rx_pktovrflow_error0, `UVM_REG_ADDR_WIDTH'h40FC, "RO");
          this.default_map.add_reg(rx_pktovrflow_error1, `UVM_REG_ADDR_WIDTH'h40FD, "RO");
          this.default_map.add_reg(rx_pktovrflow_etherStatsDropEvents0, `UVM_REG_ADDR_WIDTH'h40FE, "RO");
          this.default_map.add_reg(rx_pktovrflow_etherStatsDropEvents1, `UVM_REG_ADDR_WIDTH'h40FF, "RO");
          this.default_map.add_reg(tx_stats_clr, `UVM_REG_ADDR_WIDTH'h4140, "WRC");
          this.default_map.add_reg(rx_stats_clr, `UVM_REG_ADDR_WIDTH'h41C0, "WRC");
          this.default_map.add_reg(tx_stats_framesOK0, `UVM_REG_ADDR_WIDTH'h4142, "RO");
          this.default_map.add_reg(tx_stats_framesOK1, `UVM_REG_ADDR_WIDTH'h4143, "RO");
          this.default_map.add_reg(rx_stats_framesOK0, `UVM_REG_ADDR_WIDTH'h41C2, "RO");
          this.default_map.add_reg(rx_stats_framesOK1, `UVM_REG_ADDR_WIDTH'h41C3, "RO");
          this.default_map.add_reg(tx_stats_framesErr0, `UVM_REG_ADDR_WIDTH'h4144, "RO");
          this.default_map.add_reg(tx_stats_framesErr1, `UVM_REG_ADDR_WIDTH'h4145, "RO");
          this.default_map.add_reg(rx_stats_framesErr0, `UVM_REG_ADDR_WIDTH'h41C4, "RO");
          this.default_map.add_reg(rx_stats_framesErr1, `UVM_REG_ADDR_WIDTH'h41C5, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_fcs_lo, `UVM_REG_ADDR_WIDTH'h41C6, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_fcs_hi, `UVM_REG_ADDR_WIDTH'h41C7, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_payloadoctetsok_lo, `UVM_REG_ADDR_WIDTH'h4148, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_payloadoctetsok_hi, `UVM_REG_ADDR_WIDTH'h4149, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_payloadoctetsok_lo, `UVM_REG_ADDR_WIDTH'h41C8, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_payloadoctetsok_hi, `UVM_REG_ADDR_WIDTH'h41C9, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_pause_lo, `UVM_REG_ADDR_WIDTH'h414A, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_pause_hi, `UVM_REG_ADDR_WIDTH'h414B, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_pause_lo, `UVM_REG_ADDR_WIDTH'h41CA, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_pause_hi, `UVM_REG_ADDR_WIDTH'h41CB, "RO");
          this.default_map.add_reg(tx_stats_ifErrors0, `UVM_REG_ADDR_WIDTH'h414C, "RO");
          this.default_map.add_reg(tx_stats_ifErrors1, `UVM_REG_ADDR_WIDTH'h414D, "RO");
          this.default_map.add_reg(rx_stats_ifErrors0, `UVM_REG_ADDR_WIDTH'h41CC, "RO");
          this.default_map.add_reg(rx_stats_ifErrors1, `UVM_REG_ADDR_WIDTH'h41CD, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_ucast_data_ok_lo, `UVM_REG_ADDR_WIDTH'h414E, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_ucast_data_ok_hi, `UVM_REG_ADDR_WIDTH'h414F, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_ucast_data_ok_lo, `UVM_REG_ADDR_WIDTH'h41CE, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_ucast_data_ok_hi, `UVM_REG_ADDR_WIDTH'h41CF, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_utcast_data_err_lo, `UVM_REG_ADDR_WIDTH'h4150, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_utcast_data_err_hi, `UVM_REG_ADDR_WIDTH'h4151, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_ucast_data_err_lo, `UVM_REG_ADDR_WIDTH'h41D0, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_ucast_data_err_hi, `UVM_REG_ADDR_WIDTH'h41D1, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_mcast_data_ok_lo, `UVM_REG_ADDR_WIDTH'h4152, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_mcast_data_ok_hi, `UVM_REG_ADDR_WIDTH'h4153, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_mcast_data_ok_lo, `UVM_REG_ADDR_WIDTH'h41D2, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_mcast_data_ok_hi, `UVM_REG_ADDR_WIDTH'h41D3, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_mcast_data_err_lo, `UVM_REG_ADDR_WIDTH'h4154, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_mcast_data_err_hi, `UVM_REG_ADDR_WIDTH'h4155, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_mcast_data_err_lo, `UVM_REG_ADDR_WIDTH'h41D4, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_mcast_data_err_hi, `UVM_REG_ADDR_WIDTH'h41D5, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_bcast_data_ok_lo, `UVM_REG_ADDR_WIDTH'h4156, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_bcast_data_ok_hi, `UVM_REG_ADDR_WIDTH'h4157, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_bcast_data_ok_lo, `UVM_REG_ADDR_WIDTH'h41D6, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_bcast_data_ok_hi, `UVM_REG_ADDR_WIDTH'h41D7, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_bcast_data_err_lo, `UVM_REG_ADDR_WIDTH'h4158, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_bcast_data_err_hi, `UVM_REG_ADDR_WIDTH'h4159, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_bcast_data_err_lo, `UVM_REG_ADDR_WIDTH'h41D8, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_bcast_data_err_hi, `UVM_REG_ADDR_WIDTH'h41D9, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_octetsok_lo, `UVM_REG_ADDR_WIDTH'h415A, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_octetsok_hi, `UVM_REG_ADDR_WIDTH'h415B, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_octetsok_lo, `UVM_REG_ADDR_WIDTH'h41DA, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_octetsok_hi, `UVM_REG_ADDR_WIDTH'h41DB, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_st_lo, `UVM_REG_ADDR_WIDTH'h415C, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_st_hi, `UVM_REG_ADDR_WIDTH'h415D, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_st_lo, `UVM_REG_ADDR_WIDTH'h41DC, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_st_hi, `UVM_REG_ADDR_WIDTH'h41DD, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_runt_lo, `UVM_REG_ADDR_WIDTH'h415E, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_runt_hi, `UVM_REG_ADDR_WIDTH'h415F, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_runt_lo, `UVM_REG_ADDR_WIDTH'h41DE, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_runt_hi, `UVM_REG_ADDR_WIDTH'h41DF, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_oversize_lo, `UVM_REG_ADDR_WIDTH'h4160, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_oversize_hi, `UVM_REG_ADDR_WIDTH'h4161, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_oversize_lo, `UVM_REG_ADDR_WIDTH'h41E0, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_oversize_hi, `UVM_REG_ADDR_WIDTH'h41E1, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_64b_lo, `UVM_REG_ADDR_WIDTH'h4162, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_64b_hi, `UVM_REG_ADDR_WIDTH'h4163, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_64b_lo, `UVM_REG_ADDR_WIDTH'h41E2, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_64b_hi, `UVM_REG_ADDR_WIDTH'h41E3, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_65to127b_lo, `UVM_REG_ADDR_WIDTH'h4164, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_65to127b_hi, `UVM_REG_ADDR_WIDTH'h4165, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_65to127b_lo, `UVM_REG_ADDR_WIDTH'h41E4, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_65to127b_hi, `UVM_REG_ADDR_WIDTH'h41E5, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_128to255b_lo, `UVM_REG_ADDR_WIDTH'h4166, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_128to255b_hi, `UVM_REG_ADDR_WIDTH'h4167, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_128to255b_lo, `UVM_REG_ADDR_WIDTH'h41E6, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_128to255b_hi, `UVM_REG_ADDR_WIDTH'h41E7, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_256to511b_lo, `UVM_REG_ADDR_WIDTH'h4168, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_256to511b_hi, `UVM_REG_ADDR_WIDTH'h4169, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_256to511b_lo, `UVM_REG_ADDR_WIDTH'h41E8, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_256to511b_hi, `UVM_REG_ADDR_WIDTH'h41E9, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_512to1023b_lo, `UVM_REG_ADDR_WIDTH'h416A, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_512to1023b_hi, `UVM_REG_ADDR_WIDTH'h416B, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_512to1023b_lo, `UVM_REG_ADDR_WIDTH'h41EA, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_512to1023b_hi, `UVM_REG_ADDR_WIDTH'h41EB, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_1024to1518b_lo, `UVM_REG_ADDR_WIDTH'h416C, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_1024to1518b_hi, `UVM_REG_ADDR_WIDTH'h416D, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_1024to1518b_lo, `UVM_REG_ADDR_WIDTH'h41EC, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_1024to1518b_hi, `UVM_REG_ADDR_WIDTH'h41ED, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_1519tomaxb_lo, `UVM_REG_ADDR_WIDTH'h416E, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_1519tomaxb_hi, `UVM_REG_ADDR_WIDTH'h416F, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_1519tomaxb_lo, `UVM_REG_ADDR_WIDTH'h41EE, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_1519tomaxb_hi, `UVM_REG_ADDR_WIDTH'h41EF, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_fragments_lo, `UVM_REG_ADDR_WIDTH'h41F0, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_fragments_hi, `UVM_REG_ADDR_WIDTH'h41F1, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_jabbers_lo, `UVM_REG_ADDR_WIDTH'h41F2, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_jabbers_hi, `UVM_REG_ADDR_WIDTH'h41F3, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_fcs_err_okpkt_lo, `UVM_REG_ADDR_WIDTH'h41F4, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_fcs_err_okpkt_hi, `UVM_REG_ADDR_WIDTH'h41F5, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_ucast_ctrl_lo, `UVM_REG_ADDR_WIDTH'h4176, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_ucast_ctrl_hi, `UVM_REG_ADDR_WIDTH'h4177, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_ucast_ctrl_lo, `UVM_REG_ADDR_WIDTH'h41F6, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_ucast_ctrl_hi, `UVM_REG_ADDR_WIDTH'h41F7, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_mcast_ctrl_lo, `UVM_REG_ADDR_WIDTH'h4178, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_mcast_ctrl_hi, `UVM_REG_ADDR_WIDTH'h4179, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_mcast_ctrl_lo, `UVM_REG_ADDR_WIDTH'h41F8, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_mcast_ctrl_hi, `UVM_REG_ADDR_WIDTH'h41F9, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_bcast_ctrl_lo, `UVM_REG_ADDR_WIDTH'h417A, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_bcast_ctrl_hi, `UVM_REG_ADDR_WIDTH'h417B, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_bcast_ctrl_lo, `UVM_REG_ADDR_WIDTH'h41FA, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_bcast_ctrl_hi, `UVM_REG_ADDR_WIDTH'h41FB, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_pfc_lo, `UVM_REG_ADDR_WIDTH'h417C, "RO");
          this.default_map.add_reg(mac_stats_cntr_tx_pfc_hi, `UVM_REG_ADDR_WIDTH'h417D, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_pfc_lo, `UVM_REG_ADDR_WIDTH'h41FC, "RO");
          this.default_map.add_reg(mac_stats_cntr_rx_pfc_hi, `UVM_REG_ADDR_WIDTH'h41FD, "RO");
