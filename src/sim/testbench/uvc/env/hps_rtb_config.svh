...
`ifndef __HPS_RTB_CONFIG_SVH__
`define __HPS_RTB_CONFIG_SVH__

//------------------------------------------------------------------------------
// Class: hps_rtb_config
//
// Configuration object for MUX's RTB module.
//
//------------------------------------------------------------------------------
class hps_rtb_config extends altuvm_rtb_config;

   //---------------------------------------------------------------------------
   // UVM field Item lists
   //---------------------------------------------------------------------------
   // DUT and TB parameter lists
   `HPS_RTB_PARAM_DEFCFG
   ...
   //---------------------------------------------------------------------------
   `uvm_object_utils_begin(hps_rtb_config)
      `HPS_RTB_PARAM_DEFUVM
...
*/
   ...
   //
   function new(string name = "hps_rtb_config");
      super.new(name);
...
endclass : hps_rtb_config

`endif//__HPS_RTB_CONFIG_SVH__
