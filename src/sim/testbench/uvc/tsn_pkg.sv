...
package tsn_pkg;
   ...
   `include "tsn_tb_defaults.svh"  // contains list of localparam
   `include "tsn_tb_defines.svh"   // macros that associate with localparam
   `include "tsn_comm_abstract.svh"
   `include "hps_comm_abstract.svh"
   `include "hps_rtb_config.svh"
   `include "tsn_rtb_config.svh"
