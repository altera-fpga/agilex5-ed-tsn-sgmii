...
class an_sanity_consortium_sequence extends an_base_sequence;
   `uvm_object_utils(an_sanity_consortium_sequence)


   function new(string name = "an_sanity_consortium_sequence");
     super.new(name);
  ...
  virtual task body();
     ...
     int  node_idx_200g;
     int  node_idx_400g;
     string func_name = "an_sanity_sequence_body";
               ...
               fork
                 begin
                   if(p_sequencer.top_env.kr_cfg_inst.node_sel_50g[idx]) begin
                     `uvm_info(get_type_name(), $sformatf("Speed 50G - wait_rx_pcs_ready Inst: %0d, Node_idx: %0d, active_node: %0b, anlt_node: %0b",i,idx,p_sequencer.top_env.kr_cfg_inst.active_50g[idx],p_sequencer.top_env.kr_cfg_inst.node_sel_50g[idx]), UVM_NONE);
   		     p_sequencer.top_env.env_ip[i].dynamic_enable_disable_scoreboards(1);
                     p_sequencer.top_env.wait_rx_pcs_ready(p_sequencer.top_env.env_ip[i].dyn_rcfg_obj_inst.speed,idx,i,anlt_std);
   		     p_sequencer.top_env.env_ip[i].dynamic_enable_disable_scoreboards(0);
                     fork
               ...
               fork
                 begin
                   if(p_sequencer.top_env.kr_cfg_inst.node_sel_100g[idx]) begin
                     `uvm_info(get_type_name(), $sformatf("Speed 100G - wait_rx_pcs_ready Inst: %0d, Node_idx: %0d, active_node: %0b, anlt_node: %0b",i,idx,p_sequencer.top_env.kr_cfg_inst.active_100g[idx],p_sequencer.top_env.kr_cfg_inst.node_sel_100g[idx]), UVM_NONE);
   		     p_sequencer.top_env.env_ip[i].dynamic_enable_disable_scoreboards(1);
                     p_sequencer.top_env.wait_rx_pcs_ready(p_sequencer.top_env.env_ip[i].dyn_rcfg_obj_inst.speed,idx,i,anlt_std);
                     `uvm_info(get_type_name(), $sformatf("VIGNESH Speed 100G - wait_rx_pcs_ready Inst: %0d, Node_idx: %0d, active_node: %0b, anlt_node: %0b",i,idx,p_sequencer.top_env.kr_cfg_inst.active_100g[idx],p_sequencer.top_env.kr_cfg_inst.node_sel_100g[idx]), UVM_NONE);
   		     p_sequencer.top_env.env_ip[i].dynamic_enable_disable_scoreboards(0);
                     fork
                       send_eth_frame(DATA_FRAME,ETH_VIP_AVL_RX,10,i);  
                       send_eth_frame(DATA_FRAME,AVL_TX_ETH_VIP,10,i);  
               ...
               fork
                 begin
                   if(p_sequencer.top_env.kr_cfg_inst.node_sel_200g[idx]) begin
                     `uvm_info(get_type_name(), $sformatf("Speed 200G - wait_rx_pcs_ready Inst: %0d, Node_idx: %0d, active_node: %0b, anlt_node: %0b",i,idx,p_sequencer.top_env.kr_cfg_inst.active_200g[idx],p_sequencer.top_env.kr_cfg_inst.node_sel_200g[idx]), UVM_NONE);
   		     p_sequencer.top_env.env_ip[i].dynamic_enable_disable_scoreboards(1);
                     p_sequencer.top_env.wait_rx_pcs_ready(p_sequencer.top_env.env_ip[i].dyn_rcfg_obj_inst.speed,idx,i,anlt_std);
   		     p_sequencer.top_env.env_ip[i].dynamic_enable_disable_scoreboards(0);
                     fork
               ...
               fork
                 begin
                   if(p_sequencer.top_env.kr_cfg_inst.node_sel_400g) begin
                     `uvm_info(get_type_name(), $sformatf("Speed 400G - wait_rx_pcs_ready Inst: %0d, Node_idx: %0d, active_node: %0b, anlt_node: %0b",i,idx,p_sequencer.top_env.kr_cfg_inst.active_400g[idx],p_sequencer.top_env.kr_cfg_inst.node_sel_400g[idx]), UVM_NONE);
   		     p_sequencer.top_env.env_ip[i].dynamic_enable_disable_scoreboards(1);
                     p_sequencer.top_env.wait_rx_pcs_ready(p_sequencer.top_env.env_ip[i].dyn_rcfg_obj_inst.speed,idx,i,anlt_std);
   		     p_sequencer.top_env.env_ip[i].dynamic_enable_disable_scoreboards(0);
                     fork
...
endclass:an_sanity_consortium_sequence
