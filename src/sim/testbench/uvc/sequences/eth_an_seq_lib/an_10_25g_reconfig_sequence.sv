...
class an_10_25g_reconfig_sequence extends an_base_sequence;
   `uvm_object_utils(an_10_25g_reconfig_sequence)
   function new(string name = "an_10_25g_reconfig_sequence");
      super.new(name);
...
`endif
  ...
  `endif
   ...
   virtual task body();
      string func_name = "an_10_25g_reconfig_sequence_body";
