...
class an_a2_skiplt0_l1_p1_timer_cross_sequence_7 extends an_timer_cross_base_sequence;
   `uvm_object_utils(an_a2_skiplt0_l1_p1_timer_cross_sequence_7)
      
   function new(string name = "an_a2_skiplt0_l1_p1_timer_cross_sequence_7");
      super.new(name);
...
endclass:an_a2_skiplt0_l1_p1_timer_cross_sequence_7
