...
class an_a2_skiplt0_l2_p2_timer_cross_sequence_11 extends an_timer_cross_base_sequence;
   `uvm_object_utils(an_a2_skiplt0_l2_p2_timer_cross_sequence_11)
      
   function new(string name = "an_a2_skiplt0_l2_p2_timer_cross_sequence_11");
      super.new(name);
...
endclass:an_a2_skiplt0_l2_p2_timer_cross_sequence_11
