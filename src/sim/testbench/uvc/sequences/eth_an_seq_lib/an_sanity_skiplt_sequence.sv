...
class an_sanity_skiplt_sequence extends an_base_sequence;
   `uvm_object_utils(an_sanity_skiplt_sequence)
   function new(string name = "an_sanity_skiplt_sequence");
      super.new(name);
...
`endif
  ...
  `endif
   ...
   virtual task body();
      string func_name = "an_sanity_skiplt_sequence_body";
