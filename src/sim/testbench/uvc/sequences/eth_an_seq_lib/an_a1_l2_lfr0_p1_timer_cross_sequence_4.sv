...
class an_a1_l2_lfr0_p1_timer_cross_sequence_4 extends an_timer_cross_base_sequence;
   `uvm_object_utils(an_a1_l2_lfr0_p1_timer_cross_sequence_4)
      
   function new(string name = "an_a1_l2_lfr0_p1_timer_cross_sequence_4");
      super.new(name);
...
endclass:an_a1_l2_lfr0_p1_timer_cross_sequence_4
