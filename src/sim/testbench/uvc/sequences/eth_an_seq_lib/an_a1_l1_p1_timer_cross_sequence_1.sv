...
class an_a1_l1_p1_timer_cross_sequence_1 extends an_timer_cross_base_sequence;
   `uvm_object_utils(an_a1_l1_p1_timer_cross_sequence_1)
      
   function new(string name = "an_a1_l1_p1_timer_cross_sequence_1");
      super.new(name);
...
endclass:an_a1_l1_p1_timer_cross_sequence_1
