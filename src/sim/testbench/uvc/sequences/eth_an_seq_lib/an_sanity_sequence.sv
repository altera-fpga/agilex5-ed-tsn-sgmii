...
class an_sanity_sequence extends an_base_sequence;
   `uvm_object_utils(an_sanity_sequence)


   function new(string name = "an_sanity_sequence");
     super.new(name);
