...
class eth_stat_bcastdata_cnt_sequence extends eth_stat_base_sequence;
  `uvm_object_utils(eth_stat_bcastdata_cnt_sequence)
  ...
  virtual task body();
    `uvm_info("body", "started eth_stat_bcastdata_cnt_sequence ...", UVM_NONE)
    super.body();
    ...
    repeat(itr_cnt) begin
      ...
      std::randomize(eth_frame) with {eth_frame inside {BCAST_CTRL_FRAME,BCAST_DATA_FRAME,BCAST_CTRL_FRAME,UCAST_DATA_FRAME,MCAST_CTRL_FRAME,MCAST_DATA_FRAME};};

      fork
        begin
          randcase//Rx path 
          //(frame_num,frame_type,direction,frame_size,normal_frame,destination_address_type)
            // Revist - vinoth2x -completed
            ...
            1: send_eth_frame_with_fix_size(BCAST_DATA_FRAME,$urandom_range(1519,1525),1,ETH_VIP_AVL_RX);//oversize frame without fcs: TODO
            1: send_eth_frame_with_fcs_error(1,BCAST_DATA_FRAME,ETH_VIP_AVL_RX,$urandom_range(46,63));//undersize frame with fcs
            1: send_eth_frame_with_fcs_error(1,BCAST_DATA_FRAME,ETH_VIP_AVL_RX,$urandom_range(1519,1525));//oversize frame with fcs: TODO
	  ...
	  frame_num_rx++;
        ...
        begin
          ...
          //(frame_num,frame_type,direction,frame_size,normal_frame,destination_address_type)
            ...
            1: send_eth_frame_with_fcs_error(1,BCAST_DATA_FRAME,AVL_TX_ETH_VIP,$urandom_range(1519,1525));//oversize frame with fcs: TODO
            ...
            1: send_eth_frame_with_fix_size(BCAST_DATA_FRAME,$urandom_range(1519,1525),1,AVL_TX_ETH_VIP);//oversize frame without fcs: TODO
...
endclass : eth_stat_bcastdata_cnt_sequence
