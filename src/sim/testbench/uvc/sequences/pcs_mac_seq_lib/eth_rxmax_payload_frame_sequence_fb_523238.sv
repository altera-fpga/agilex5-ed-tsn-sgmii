...
class eth_rxmax_payload_frame_sequence_fb_523238 extends eth_base_sequence;
  alt_eth_vip_custom_sequence eth_seq;
  uvm_reg_data_t read_data,cfg_payload_size,rx_max_read_data;
  int frame_count = 0;
  
  `uvm_object_utils(eth_rxmax_payload_frame_sequence_fb_523238)
  
  function new(string name = "eth_rxmax_payload_frame_sequence_fb_523238");
    super.new(name);
  ...
  virtual task body();
    ...
    `uvm_info("eth_rxmax_payload_frame_sequence_fb_523238", "Executing eth_rxmax_payload_frame_sequence_fb_523238 ...", UVM_LOW)
    ...
    `uvm_info("eth_rxmax_payload_frame_sequence_fb_523238", "Exiting eth_rxmax_payload_frame_sequence_fb_523238 ...", UVM_LOW)
  endtask
