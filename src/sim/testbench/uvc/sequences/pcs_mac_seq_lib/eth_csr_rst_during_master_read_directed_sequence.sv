...
//class eth_csr_rst_during_master_read_directed_sequence extends eth_base_sequence;
//  uvm_reg_data_t rd_data;
//
//  `uvm_object_utils(eth_csr_rst_during_master_read_directed_sequence)
//
//  function new(string name = "eth_csr_rst_during_master_read_directed_sequence");
//    super.new(name);
...
//        `uvm_info("eth_csr_rst_during_master_read_directed_sequence", "SPY_IF master_read started ...", UVM_NONE)
//        wait(p_sequencer.env.spy_if.cfg_load_done==0);
//        wait(p_sequencer.env.spy_if.cfg_load_done==1);
//        `uvm_info("eth_csr_rst_during_master_read_directed_sequence", "SPY_IF cfg_load_done after forced CSR reset...", UVM_NONE)
...
//  endtask//body
//
//endclass//eth_csr_rst_during_master_read_directed_sequence
