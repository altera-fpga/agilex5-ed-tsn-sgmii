...
class extended_reset_sanity_sequence extends eth_base_sequence;

  `uvm_object_utils(extended_reset_sanity_sequence)
  ...
  virtual task body();
    `uvm_info("eth_seq_lib", "running sanity sequence with extended reset\n",UVM_LOW)
