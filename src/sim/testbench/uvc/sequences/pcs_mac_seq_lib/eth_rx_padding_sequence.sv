...
//class eth_rx_padding_sequence extends eth_base_sequence;
//  bit rx_crc_pass;
//  bit rx_rmpad;
//  //ethernet_random_sequence eth_seq;
//  `uvm_object_utils(eth_rx_padding_sequence)
...
//    `uvm_info("eth_seq_lib", "running eth_rx_padding_sequence\n",UVM_LOW)
...
//    //`ifndef CRETE3  //dsamantx:FIX ME for GDR
//    if(rd_data[8]!=p_sequencer.env.dyn_rcfg_obj_inst.rm_rx_pads)   `uvm_error("rx_padding_sequence", $sformatf("REGISTERS_RXMAC_CONTROL_OFFSET_REG bit 8 value must be initialized as per parameter"));   //dsamantx:FIX_ME as rm_rx_pads param not found in GDR dyn_rcfg
//    //`endif
//    rx_rmpad=$urandom;
//    rx_crc_pass=$urandom;
...
//   `endif
//  endtask
//endclass: eth_rx_padding_sequence
