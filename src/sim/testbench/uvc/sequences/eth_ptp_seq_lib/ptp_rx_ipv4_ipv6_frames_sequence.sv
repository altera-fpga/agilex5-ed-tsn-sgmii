...
class ptp_rx_ipv4_ipv6_frames_sequence extends eth_ptp_base_sequence;
  ptp_op_e ptp_op;
  frame_type f_type;
  bit mix_rule;

  `uvm_object_utils(ptp_rx_ipv4_ipv6_frames_sequence)
  function new(string name = "ptp_rx_ipv4_ipv6_frames_sequence");
    super.new(name);
 ...
 virtual task body();
   ...
   `endif
   `uvm_info("eth_seq_lib", "running ptp_rx_ipv4_ipv6_frames_sequence\n",UVM_LOW)
   //mix_rule = $urandom();
   mix_rule = 0;
   fork
    begin
...
endclass : ptp_rx_ipv4_ipv6_frames_sequence
