...
class ptp_v1_ts_ins_add_eb_w_asym_lat_sequence extends eth_ptp_base_sequence;

  `uvm_object_utils(ptp_v1_ts_ins_add_eb_w_asym_lat_sequence)
  function new(string name = "ptp_v1_ts_ins_add_eb_w_asym_lat_sequence");
    super.new(name);
  ...
  virtual task body();
    super.body();
    `uvm_info("eth_seq_lib", "running ptp_v1_ts_ins_add_eb_w_asym_lat_sequence\n",UVM_LOW)
...
endclass : ptp_v1_ts_ins_add_eb_w_asym_lat_sequence
