...
class eth_testsuite_100g_cl91_comp_tc_7_seq extends eth_testsuite_100g_cl91_comp_seq;
  
  `uvm_object_utils(eth_testsuite_100g_cl91_comp_tc_7_seq)

  function new(string name = "eth_testsuite_100g_cl91_comp_tc_7_seq");
    super.new(name);
  ...
  virtual task pre_body();
     first_case = 7;
     last_case = 7;
     //remove this checker once case resolves from synopsys
...
endclass : eth_testsuite_100g_cl91_comp_tc_7_seq
