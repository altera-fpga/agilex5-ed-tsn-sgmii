...
class eth_rsfec_reg_reset_sequence extends eth_base_sequence;
   
  `uvm_object_utils(eth_rsfec_reg_reset_sequence)

  function new(string name = "eth_rsfec_reg_reset_sequence");
    super.new(name);
