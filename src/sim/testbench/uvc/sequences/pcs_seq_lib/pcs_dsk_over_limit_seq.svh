...
class pcs_dsk_over_limit_sequence extends pcs_base_sequence;
//  sequence_0 tx_seq;
  bit rx_crc_pass;
//  ethernet_random_sequence eth_seq;
  `uvm_object_utils(pcs_dsk_over_limit_sequence)

   class local_seq_var extends seq_var; 
    
     constraint num_lanes_c {
       num_lanes dist {[2:19] := 50, 1:=50};
     }
     constraint skew_0_c {
        if(lane_0 == 0) (skew_0 inside {[1:301]});
      }

     constraint skew_1_c {
        if(lane_0 == 1) (skew_1 inside {[1:301]});
      }
     constraint skew_2_c {
        if(lane_0 == 2) (skew_2 inside {[1:301]});
      }
     constraint skew_3_c {
        if(lane_0 == 3) (skew_3 inside {[1:301]});
      }
     constraint skew_4_c {
        if(lane_0 == 4) (skew_4 inside {[1:301]});
      }
     constraint skew_5_c {
        if(lane_0 == 5) (skew_5 inside {[1:301]});
      }
     constraint skew_6_c {
        if(lane_0 == 6) (skew_6 inside {[1:301]});
      }
     constraint skew_7_c {
        if(lane_0 == 7) (skew_7 inside {[1:301]});
      }
     constraint skew_8_c {
        if(lane_0 == 8) (skew_8 inside {[1:301]});
      }
     constraint skew_9_c {
        if(lane_0 == 9) (skew_9 inside {[1:301]});
      }
     constraint skew_10_c {
        if(lane_0 == 10) (skew_10 inside {[1:301]});
      }
     constraint skew_11_c {
        if(lane_0 == 11) (skew_11 inside {[1:301]});
      }
     constraint skew_12_c {
        if(lane_0 == 12) (skew_12 inside {[1:301]});
      }
     constraint skew_13_c {
        if(lane_0 == 13) (skew_13 inside {[1:301]});
      }
     constraint skew_14_c {
        if(lane_0 == 14) (skew_14 inside {[1:301]});
      }
     constraint skew_15_c {
        if(lane_0 == 15) (skew_15 inside {[1:301]});
      }
     constraint skew_16_c {
        if(lane_0 == 16) (skew_16 inside {[1:301]});
      }
     constraint skew_17_c {
        if(lane_0 == 17) (skew_17 inside {[1:301]});
      }
     constraint skew_18_c {
        if(lane_0 == 18) (skew_18 inside {[1:301]});
      }
     constraint skew_19_c {
        if(lane_0 == 19) (skew_19 inside {[1:301]});
      }

   endclass

  local_seq_var m_seq_var;
  local_seq_var m_seq_var_1;
  local_seq_var m_seq_var_2;

  function new(string name = "pcs_dsk_over_limit_sequence");
    super.new(name);
    m_seq_var = new(); 
    m_seq_var_1 = new(); 
    m_seq_var_2 = new(); 
...
// tx_seq=new("tx_seq");  
  ...
  virtual task body();
    ...
    // Dsk fifo depth is ? 
    // check for loss of lock (link should go down). 
    // reduce skew to within limits
    // wait for recovery
 ...
 //  tx_seq.start(p_sequencer.tx_seqr);
      ...
      if (!m_seq_var.randomize() with {m_seq_var.skew_0  == 30; m_seq_var.skew_1  == 30; m_seq_var.skew_2  == 30; m_seq_var.skew_3  == 30; m_seq_var.skew_4  == 30; m_seq_var.skew_5  == 30; m_seq_var.skew_6  == 30; m_seq_var.skew_7  == 30; m_seq_var.skew_8  == 30; m_seq_var.skew_9  == 30; m_seq_var.skew_10  == 30; m_seq_var.skew_11  == 30; m_seq_var.skew_12  == 30; m_seq_var.skew_13  == 30; m_seq_var.skew_14  == 30; m_seq_var.skew_15  == 30; m_seq_var.skew_16  == 30; m_seq_var.skew_17  == 30; m_seq_var.skew_18  == 30; m_seq_var.skew_19  == 30; } ) begin
...
//       end
        ...
        `uvm_info(get_type_name(), $sformatf("Wait before reducing skew to within tolerance"), UVM_LOW)
         //Wait for some time before reducing skew
         #50us;

        //Reset skew on all lanes
        `uvm_info(get_type_name(), $sformatf("Resetting skew on all lanes"), UVM_LOW)
         m_seq_var_1 = new();
         m_seq_var_1.num_lanes_c.constraint_mode(0);
         m_seq_var_1.skew_0_c.constraint_mode(0);
         m_seq_var_1.skew_1_c.constraint_mode(0);
         m_seq_var_1.skew_2_c.constraint_mode(0);
         m_seq_var_1.skew_3_c.constraint_mode(0);
         m_seq_var_1.skew_4_c.constraint_mode(0);
         m_seq_var_1.skew_5_c.constraint_mode(0);
         m_seq_var_1.skew_6_c.constraint_mode(0);
         m_seq_var_1.skew_7_c.constraint_mode(0);
         m_seq_var_1.skew_8_c.constraint_mode(0);
         m_seq_var_1.skew_9_c.constraint_mode(0);
         m_seq_var_1.skew_10_c.constraint_mode(0);
         m_seq_var_1.skew_11_c.constraint_mode(0);
         m_seq_var_1.skew_12_c.constraint_mode(0);
         m_seq_var_1.skew_13_c.constraint_mode(0);
         m_seq_var_1.skew_14_c.constraint_mode(0);
         m_seq_var_1.skew_15_c.constraint_mode(0);
         m_seq_var_1.skew_16_c.constraint_mode(0);
         m_seq_var_1.skew_17_c.constraint_mode(0);
         m_seq_var_1.skew_18_c.constraint_mode(0);
         m_seq_var_1.skew_19_c.constraint_mode(0);
         if (!m_seq_var_1.randomize() with {m_seq_var_1.skew_0 ==0; m_seq_var_1.skew_1 ==0; m_seq_var_1.skew_2 ==0; m_seq_var_1.skew_3 ==0; m_seq_var_1.skew_4 ==0; m_seq_var_1.skew_5 ==0; m_seq_var_1.skew_6 ==0; m_seq_var_1.skew_7 ==0; m_seq_var_1.skew_8 ==0; m_seq_var_1.skew_9 ==0; m_seq_var_1.skew_10 ==0; m_seq_var_1.skew_11 ==0; m_seq_var_1.skew_12 ==0; m_seq_var_1.skew_13 ==0; m_seq_var_1.skew_14 ==0; m_seq_var_1.skew_15 ==0; m_seq_var_1.skew_16 ==0; m_seq_var_1.skew_17 ==0; m_seq_var_1.skew_18 ==0; m_seq_var_1.skew_19 ==0;  m_seq_var_1.num_lanes == 20;} ) begin
           `uvm_fatal(get_type_name(), "Randomization of seq_var failed")
         end  
 
         `uvm_info(get_type_name(), $sformatf("2 num_lanes :%d, lane_0 :%d, lane_1 :%d, lane_2 :%d, lane_3 :%d, lane_4 :%d, lane_5 :%d, lane_6 :%d, lane_7 :%d, lane_8 :%d, lane_9 :%d, lane_10 :%d, lane_11 :%d, lane_12 :%d, lane_13 :%d, lane_14 :%d, lane_15 :%d, lane_16 :%d, lane_17 :%d, lane_18 :%d, lane19 :%d, num_invalid_am :%d", m_seq_var_1.num_lanes, m_seq_var_1.lane_0, m_seq_var_1.lane_1, m_seq_var_1.lane_2, m_seq_var_1.lane_3, m_seq_var_1.lane_4, m_seq_var_1.lane_5, m_seq_var_1.lane_6, m_seq_var_1.lane_7, m_seq_var_1.lane_8, m_seq_var_1.lane_9, m_seq_var_1.lane_10, m_seq_var_1.lane_11, m_seq_var_1.lane_12, m_seq_var_1.lane_13, m_seq_var_1.lane_14, m_seq_var_1.lane_15, m_seq_var_1.lane_16, m_seq_var_1.lane_17, m_seq_var_1.lane_18, m_seq_var_1.lane_19, m_seq_var_1.num_invalid_am ), UVM_LOW)
         `uvm_info(get_type_name(), $sformatf("2 num_lanes :%d, skew_0 :%d, skew_1 :%d, skew_2 :%d, skew_3 :%d, skew_4 :%d, skew_5 :%d, skew_6 :%d, skew_7 :%d, skew_8 :%d, skew_9 :%d, skew_10 :%d, skew_11 :%d, skew_12 :%d, skew_13 :%d, skew_14 :%d, skew_15 :%d, skew_16 :%d, skew_17 :%d, skew_18 :%d, lane19 :%d, num_invalid_am :%d", m_seq_var_1.num_lanes, m_seq_var_1.skew_0, m_seq_var_1.skew_1, m_seq_var_1.skew_2, m_seq_var_1.skew_3, m_seq_var_1.skew_4, m_seq_var_1.skew_5, m_seq_var_1.skew_6, m_seq_var_1.skew_7, m_seq_var_1.skew_8, m_seq_var_1.skew_9, m_seq_var_1.skew_10, m_seq_var_1.skew_11, m_seq_var_1.skew_12, m_seq_var_1.skew_13, m_seq_var_1.skew_14, m_seq_var_1.skew_15, m_seq_var_1.skew_16, m_seq_var_1.skew_17, m_seq_var_1.skew_18, m_seq_var_1.skew_19, m_seq_var_1.num_invalid_am ), UVM_LOW)
         
         //insert reduced skew 
         insert_skew(m_seq_var_1);

         //Wait for some time before reducing skew
         #5us;

        `uvm_info(get_type_name(), $sformatf("Reducing skew to within tolerance"), UVM_LOW)
         m_seq_var_2 = new();
         //m_seq_var_2.num_lanes_c.constraint_mode(0); 
         //Reduce skew to within limits on all lanes
         if (!m_seq_var_2.randomize() with {m_seq_var_2.skew_0 inside {[1:12]}; m_seq_var_2.skew_1 inside {[1:12]}; m_seq_var_2.skew_2 inside {[1:12]}; m_seq_var_2.skew_3 inside {[1:12]}; m_seq_var_2.skew_4 inside {[1:12]}; m_seq_var_2.skew_5 inside {[1:12]}; m_seq_var_2.skew_6 inside {[1:12]}; m_seq_var_2.skew_7 inside {[1:12]}; m_seq_var_2.skew_8 inside {[1:12]}; m_seq_var_2.skew_9 inside {[1:12]}; m_seq_var_2.skew_10 inside {[1:12]}; m_seq_var_2.skew_11 inside {[1:12]}; m_seq_var_2.skew_12 inside {[1:12]}; m_seq_var_2.skew_13 inside {[1:12]}; m_seq_var_2.skew_14 inside {[1:12]}; m_seq_var_2.skew_15 inside {[1:12]}; m_seq_var_2.skew_16 inside {[1:12]}; m_seq_var_2.skew_17 inside {[1:12]}; m_seq_var_2.skew_18 inside {[1:12]}; m_seq_var_2.skew_19 inside {[1:12]};  m_seq_var_2.num_lanes inside {[1:19]};} ) begin
           `uvm_fatal(get_type_name(), "Randomization of seq_var failed")
        end  
      
      `uvm_info(get_type_name(), $sformatf("3 num_lanes :%d, lane_0 :%d, lane_1 :%d, lane_2 :%d, lane_3 :%d, lane_4 :%d, lane_5 :%d, lane_6 :%d, lane_7 :%d, lane_8 :%d, lane_9 :%d, lane_10 :%d, lane_11 :%d, lane_12 :%d, lane_13 :%d, lane_14 :%d, lane_15 :%d, lane_16 :%d, lane_17 :%d, lane_18 :%d, lane19 :%d, num_invalid_am :%d", m_seq_var_2.num_lanes, m_seq_var_2.lane_0, m_seq_var_2.lane_1, m_seq_var_2.lane_2, m_seq_var_2.lane_3, m_seq_var_2.lane_4, m_seq_var_2.lane_5, m_seq_var_2.lane_6, m_seq_var_2.lane_7, m_seq_var_2.lane_8, m_seq_var_2.lane_9, m_seq_var_2.lane_10, m_seq_var_2.lane_11, m_seq_var_2.lane_12, m_seq_var_2.lane_13, m_seq_var_2.lane_14, m_seq_var_2.lane_15, m_seq_var_2.lane_16, m_seq_var_2.lane_17, m_seq_var_2.lane_18, m_seq_var_2.lane_19, m_seq_var_2.num_invalid_am ), UVM_LOW)
      `uvm_info(get_type_name(), $sformatf("3 num_lanes :%d, skew_0 :%d, skew_1 :%d, skew_2 :%d, skew_3 :%d, skew_4 :%d, skew_5 :%d, skew_6 :%d, skew_7 :%d, skew_8 :%d, skew_9 :%d, skew_10 :%d, skew_11 :%d, skew_12 :%d, skew_13 :%d, skew_14 :%d, skew_15 :%d, skew_16 :%d, skew_17 :%d, skew_18 :%d, lane19 :%d, num_invalid_am :%d", m_seq_var_2.num_lanes, m_seq_var_2.skew_0, m_seq_var_2.skew_1, m_seq_var_2.skew_2, m_seq_var_2.skew_3, m_seq_var_2.skew_4, m_seq_var_2.skew_5, m_seq_var_2.skew_6, m_seq_var_2.skew_7, m_seq_var_2.skew_8, m_seq_var_2.skew_9, m_seq_var_2.skew_10, m_seq_var_2.skew_11, m_seq_var_2.skew_12, m_seq_var_2.skew_13, m_seq_var_2.skew_14, m_seq_var_2.skew_15, m_seq_var_2.skew_16, m_seq_var_2.skew_17, m_seq_var_2.skew_18, m_seq_var_2.skew_19, m_seq_var_2.num_invalid_am ), UVM_LOW)

      //insert reduced skew 
      insert_skew(m_seq_var_2);
