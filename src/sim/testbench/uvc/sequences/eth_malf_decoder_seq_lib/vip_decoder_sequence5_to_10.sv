...
class vip_decoder_sequence5_to_10 extends vip_error_base_sequence;
      
   `uvm_object_utils(vip_decoder_sequence5_to_10)
     alt_eth_error_vip_base_sequence err_seq;
   
   function new(string name = "vip_decoder_sequence5_to_10");
      super.new(name);
  ...
  `endif
   ...
   virtual task body();
      ...
      ////////////////////////////////////////////////////
      ////// Phase 1: B2B frames - IFG=18. Allow for <Start><frame><Term><Term><Term><Start> ////////////////
      ////////////////////////////////////////////////////
      ...
      #200ns;
     //Disabling the task call since fb is corrupted vip can drop those packets.
     // p_sequencer.env.wait_vip_tx_frames_done(.exp_num(total_num_frames_sent),.timeout_time(frame_timeout_time)); 
      ...
      ////////////////////////////////////////////////////
      ////// Phase 2: B2B frames - IFG=25. Allow for <Start><frame><Term><Term><Idle><Term><Start> ////////////////
      ////////////////////////////////////////////////////
      total_num_frames_sent=total_num_frames_sent+sequence_length;
      `uvm_create_on(err_seq,p_sequencer.eth_vip_seqr_inst)
...
endclass // vip_decoder_sequence5_to_10
