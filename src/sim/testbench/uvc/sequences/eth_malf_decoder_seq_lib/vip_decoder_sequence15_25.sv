...
class vip_decoder_sequence15_25 extends vip_error_base_sequence;
      
   `uvm_object_utils(vip_decoder_sequence15_25)
     alt_eth_error_vip_base_sequence err_seq;
   
   function new(string name = "vip_decoder_sequence15_25");
      super.new(name);
  ...
  `endif
   ...
   virtual task body();
      ...
      if(p_sequencer.env.dyn_rcfg_obj_inst.speed inside {_10G,_25G,_40G,_50G,_100G}) begin
        //GDR : p_sequencer.env.reg_write(`GET_REG_ADDR(ehip_cfg_xus_timer_window_OFFSET_REG,p_sequencer.env.dyn_rcfg_obj_inst.speed),2000); // Configuring BER timer for 2000 clock cycles        
...
endclass // vip_decoder_sequence15_25
