...
class vip_decoder_sequence15_25_ext extends vip_error_base_sequence;
      
   `uvm_object_utils(vip_decoder_sequence15_25_ext)
     alt_eth_error_vip_base_sequence err_seq;
   
   function new(string name = "vip_decoder_sequence15_25_ext");
      super.new(name);
...
endclass // vip_decoder_sequence15_25_ext
