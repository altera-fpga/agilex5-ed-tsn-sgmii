...
class vip_decoder_sequence2 extends vip_error_base_sequence;

   `uvm_object_utils(vip_decoder_sequence2)
     alt_eth_error_vip_base_sequence err_seq;
   
   function new(string name = "vip_decoder_sequence2");
      super.new(name);
  ...
  `endif
   ...
   virtual task body();
      ...
      p_sequencer.env.`M_SNPS_ETH_PCS66_AGENT.monitor.err_check_tx.svt_err_xsbi_signal_ordered_set.set_default_fail_effect(svt_err_check_stats::IGNORE);
...
endclass // vip_decoder_sequence2
