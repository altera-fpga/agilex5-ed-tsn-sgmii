...
class vip_decoder_sequence16_21 extends vip_error_base_sequence;
      
   `uvm_object_utils(vip_decoder_sequence16_21)
     alt_eth_error_vip_base_sequence err_seq;
   
   function new(string name = "vip_decoder_sequence16_21");
      super.new(name);
...
endclass // vip_decoder_sequence16_21
