...
class vip_decoder_sequence28 extends vip_error_base_sequence;
      
   `uvm_object_utils(vip_decoder_sequence28)
     alt_eth_error_vip_base_sequence err_seq;
   
   function new(string name = "vip_decoder_sequence28");
      super.new(name);
  ...
  `endif
   ...
   virtual task body();
      ...
      ////////////////////////////////////////////////////
      ////// Phase 1: B2B frames - IFG=60. Allow for <Start><frame><Term><Term><Term><Start> ////////////////
      ////////////////////////////////////////////////////
...
endclass // vip_decoder_sequence28
