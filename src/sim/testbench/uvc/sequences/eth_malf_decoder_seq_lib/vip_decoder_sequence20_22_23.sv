...
class vip_decoder_sequence20_22_23 extends vip_error_base_sequence;
      
   `uvm_object_utils(vip_decoder_sequence20_22_23)
     alt_eth_error_vip_base_sequence err_seq;
   
   function new(string name = "vip_decoder_sequence20_22_23");
      super.new(name);
  ...
  `endif
   ...
   virtual task body();
      ...
      exception.baser_encoder_error_position = svt_ethernet_transaction_exception::BASER_ENCODER_INSERT_ERR_BEFORE_START_FRAME;
      exception_list.add_exception(exception);
      // Random Data block before frame
      exception = new();
      exception.error_kind = svt_ethernet_transaction_exception::BASER_100G_ERROR_KIND;
...
endclass // vip_decoder_sequence20_22_23
