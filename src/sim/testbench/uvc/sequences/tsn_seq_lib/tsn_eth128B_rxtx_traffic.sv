class tsn_eth128B_rxtx_traffic extends eth_base_sequence;

    `uvm_object_utils(tsn_eth128B_rxtx_traffic)
    ...
    virtual task body();
      ...
      `ifdef ENABLE_ETH_VIP
          fork
            send_constrained_eth_frame(USER_DEFINED_FRAME,ETH_VIP_AVL_RX,num_of_frames,110,0,110);  
            send_constrained_eth_frame(DATA_FRAME,AVL_TX_ETH_VIP,num_of_frames,110,1,128);  
  ...
  endclass: tsn_eth128B_rxtx_traffic
