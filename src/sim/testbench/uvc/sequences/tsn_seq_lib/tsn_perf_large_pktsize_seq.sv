class tsn_perf_large_pktsize_seq extends eth_base_sequence;

  `uvm_object_utils(tsn_perf_large_pktsize_seq)
  ...
  virtual task body();
    ...
    `ifdef ENABLE_ETH_VIP
          ...
          fork
            send_constrained_eth_frame(USER_DEFINED_FRAME,ETH_VIP_AVL_RX,num_of_frames,1500,0,1500);  
            send_constrained_eth_frame(DATA_FRAME,AVL_TX_ETH_VIP,num_of_frames,1500,1,1518);  
          join
...
endclass: tsn_perf_large_pktsize_seq
