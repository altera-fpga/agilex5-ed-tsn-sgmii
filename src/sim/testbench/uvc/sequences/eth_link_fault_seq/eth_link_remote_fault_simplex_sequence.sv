...
class eth_link_remote_fault_simplex_sequence extends eth_base_sequence;
  uvm_reg_data_t read_data;
  bit link_fault_en;
  int data_on_mii = 0 ;
  int node;
  `uvm_object_utils(eth_link_remote_fault_simplex_sequence)

  function new(string name = "eth_link_remote_fault_simplex_sequence");
    super.new(name);
