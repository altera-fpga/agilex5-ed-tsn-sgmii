...
class eth_link_local_fault_128blk_sequence extends eth_base_sequence;
...
`endif
  ...
  `uvm_object_utils(eth_link_local_fault_128blk_sequence)

  function new(string name = "eth_link_local_fault_128blk_sequence");
    super.new(name);
