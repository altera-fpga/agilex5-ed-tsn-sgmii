...
`altuvm_sva_cover(SPTP_SIMULTANEOUS_TX_RX_TAM_REQ, (!loading_in_progress_p32 && req_tx_tam && req_rx_tam), (posedge i_clk) , (!i_rst_n) )
`altuvm_sva_cover(SPTP_NEW_TAM_REQ_WHEN_LOAD_IN_PROG, (loading_in_progress_p32 && ($rose(req_tx_tam) || $rose(req_rx_tam)) ), (posedge i_clk) , (!i_rst_n) )
