...
`altuvm_sva_cover(SPTP_TX_EOP_AT_WORDSn, (i_tx_valid && o_tx_eop_pline[0][i]), (posedge i_clk), (!i_rst_n) )
end

if (PKT_CYL==2) begin: cvp_e400g
`altuvm_sva_cover(SPTP_TWO_TX_PKT_IN_ONE_CYCLE_400G, (loword_sop && hiword_sop && loword_eop && hiword_eop), (posedge i_clk), (!i_rst_n) )
end
endgenerate
