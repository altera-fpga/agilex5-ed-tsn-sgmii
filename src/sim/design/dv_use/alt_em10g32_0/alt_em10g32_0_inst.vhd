	component alt_em10g32_0 is
		port (
			...
			gmii16b_tx_clk             : in  std_logic                     := 'X';             -- clk
			gmii16b_tx_d               : out std_logic_vector(15 downto 0);                    -- export
			gmii16b_tx_en              : out std_logic_vector(1 downto 0);                     -- export
			gmii16b_tx_err             : out std_logic_vector(1 downto 0);                     -- export
			...
			gmii16b_rx_clk             : in  std_logic                     := 'X';             -- clk
			gmii16b_rx_d               : in  std_logic_vector(15 downto 0) := (others => 'X'); -- export
			gmii16b_rx_dv              : in  std_logic_vector(1 downto 0)  := (others => 'X'); -- export
			gmii16b_rx_err             : in  std_logic_vector(1 downto 0)  := (others => 'X'); -- export
	...
	end component alt_em10g32_0;

	u0 : component alt_em10g32_0
		port map (
			...
			gmii16b_tx_clk             => CONNECTED_TO_gmii16b_tx_clk,             --     gmii16b_tx_clk.clk
			gmii16b_tx_d               => CONNECTED_TO_gmii16b_tx_d,               --       gmii16b_tx_d.export
			gmii16b_tx_en              => CONNECTED_TO_gmii16b_tx_en,              --      gmii16b_tx_en.export
			gmii16b_tx_err             => CONNECTED_TO_gmii16b_tx_err,             --     gmii16b_tx_err.export
			...
			gmii16b_rx_clk             => CONNECTED_TO_gmii16b_rx_clk,             --     gmii16b_rx_clk.clk
			gmii16b_rx_d               => CONNECTED_TO_gmii16b_rx_d,               --       gmii16b_rx_d.export
			gmii16b_rx_dv              => CONNECTED_TO_gmii16b_rx_dv,              --      gmii16b_rx_dv.export
			gmii16b_rx_err             => CONNECTED_TO_gmii16b_rx_err,             --     gmii16b_rx_err.export
