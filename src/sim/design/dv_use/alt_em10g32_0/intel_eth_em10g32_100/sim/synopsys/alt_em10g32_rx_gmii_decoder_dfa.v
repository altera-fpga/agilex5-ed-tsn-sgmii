...
`timescale 1ns / 100ps
module alt_em10g32_rx_gmii_decoder_dfa (
   ...
   always @(posedge clk) begin
      if (!reset_n) begin
         ...
         if (out_ready || ~out_valid) begin
            out_valid <= b_valid & ~(b_startofpacket & b_endofpacket);
