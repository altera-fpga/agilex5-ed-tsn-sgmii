...
`timescale 1 ps / 1 ps
module alt_em10g32_avalon_dc_fifo_secc (
    ...
    // Parameter: altera_avalon_dc_fifo
    ...
    wire [FIFO_WIDTH-1 : 0]    dc_fifo_sink_data;
    
    wire                       dc_fifo_src_valid;
    wire                       dc_fifo_src_ready;
    wire [FIFO_WIDTH-1 : 0]    dc_fifo_src_data;
    ...
    assign pipeline_enc_out_src_ready = dc_fifo_sink_ready;
    
    // SC FIFO
    assign dc_fifo_sink_valid = REGISTER_ENC_OUTPUT ? pipeline_enc_out_src_valid : pipeline_enc_out_sink_valid;
    assign dc_fifo_sink_data = REGISTER_ENC_OUTPUT ? pipeline_enc_out_src_data : pipeline_enc_out_sink_data;
    ...
    altera_avalon_dc_fifo #(
        ...
        .STREAM_ALMOST_FULL  (STREAM_ALMOST_FULL),
        .STREAM_ALMOST_EMPTY (STREAM_ALMOST_EMPTY),
        ...
        .in_data            (dc_fifo_sink_data),
        .in_valid           (dc_fifo_sink_valid),
        .in_startofpacket   (1'b0),
        .in_endofpacket     (1'b0),
        .in_empty           (1'b0),
        .in_error           (1'b0),
        .in_channel         (1'b0),
        .in_ready           (dc_fifo_sink_ready),
        
        .out_data           (dc_fifo_src_data),
        .out_valid          (dc_fifo_src_valid),
        .out_startofpacket  (),
        .out_endofpacket    (),
        .out_empty          (),
        .out_error          (),
        .out_channel        (),
        .out_ready          (dc_fifo_src_ready),
    ...
    assign pipeline_dec_in_sink_valid = dc_fifo_src_valid;
    assign pipeline_dec_in_sink_data = dc_fifo_src_data;
    assign dc_fifo_src_ready = REGISTER_DEC_INPUT ? pipeline_dec_in_sink_ready : pipeline_dec_in_src_ready;
    ...
    generate for(i = 0; i < ECC_BLOCK_NUM; i = i + 1)
        begin : ecc_dec_gen
            if(ENABLE_MEM_ECC) begin
                ...
                assign dec_out_data_concat = {MULTI_ECC_IN_WIDTH{1'b0}};
