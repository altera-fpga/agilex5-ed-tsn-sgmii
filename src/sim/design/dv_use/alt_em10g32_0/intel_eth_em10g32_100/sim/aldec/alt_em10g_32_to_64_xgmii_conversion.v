...
module alt_em10g_32_to_64_xgmii_conversion
(
...
reg [31:0] xgmii_data_in_reg /* synthesis altera_attribute="suppress_da_rule_internal=D101" */;
reg [3:0] xgmii_control_in_reg /* synthesis altera_attribute="suppress_da_rule_internal=D101" */;
...
reg [15:0] xgmii_tx_path_latency_reg /* synthesis altera_attribute="suppress_da_rule_internal=\"D101,D102\"" */;
reg conversion_ready /* synthesis altera_attribute="suppress_da_rule_internal=D101" */;

assign st_tx_path_latency = {xgmii_tx_path_latency_reg[15:0], 1'b0};
  ...
  generate if (SYNC_RESET_N == 1) begin
    ...
    begin
       ...
       begin
          ...
          xgmii_tx_path_latency_reg <= 16'b0;
       end
       else
       begin
          if (conversion_ready)
          begin
             xgmii_data_out <= {xgmii_data_in, xgmii_data_in_reg};
             xgmii_control_out <= {xgmii_control_in, xgmii_control_in_reg};
          end
          else
          begin
             xgmii_data_out <= {SYM_IDLE, SYM_IDLE, SYM_IDLE, SYM_IDLE, SYM_IDLE, SYM_IDLE, SYM_IDLE, SYM_IDLE};
          ...
          xgmii_tx_path_latency_reg <= xgmii_tx_path_latency;
       end
    end
  end else begin
    always @ (posedge clk_xgmii_out or negedge reset_xgmii_out_n)
