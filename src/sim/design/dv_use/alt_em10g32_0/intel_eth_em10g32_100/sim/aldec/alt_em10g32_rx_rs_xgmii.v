...
module alt_em10g32_rx_rs_xgmii (
   // Clock and reset
   ...
   output reg rx_tsfr_sts_xgmii,
   output reg packet_in_progress_xgmii,
...
wire cond_0, cond_1, cond_2, cond_3;
wire err_cond_0, err_cond_1, err_cond_2, err_cond_3;
reg is_pream0;
reg is_pream1;

wire sop, eop, valid, err_valid;
wire [1:0] empty;
...
assign err_cond_0 = err_valid & data_3_reg_1 & data_2_reg_1 & data_1_reg_1 & data_0_reg_1 & err_0_reg_0; 
assign err_cond_1 = err_valid & data_0_reg_1 & err_1_reg_1;
assign err_cond_2 = err_valid & data_1_reg_1 & err_2_reg_1;
assign err_cond_3 = err_valid & data_2_reg_1 & err_3_reg_1;
...
always @ (posedge top2rs_xgmii_rx_clk)
    ...
    if(~top2rs_xgmii_rx_rst_b)
        begin
        rx_tsfr_sts_xgmii <= 1'b0;
        end
    else    
        begin

        if(state == IDLE && rx_top2rs_xgmii_rx_valid)
            begin
            rx_tsfr_sts_xgmii <= csr_rx_tsfr_en_n;
            end
        end
    end
...
assign valid = (state == DATA || state == END) ? 1'b1 : 1'b0;
assign err_valid = (state ==PREAM1 || state == DATA || state == END) ? 1'b1 : 1'b0;
...
begin
   ...
   begin
      ...
      begin
         if ((err_cond_0 | err_cond_1 | err_cond_2 | err_cond_3) && rx_top2rs_xgmii_rx_valid)
         begin
...
begin
   ...
   begin
      ...
      begin
        rx_ethfrm_sop_10g <= 0;
        rx_ethfrm_eop_10g <= 0;
        rx_ethfrm_valid_10g <= 0;
        rx_ethfrm_empty_10g <= 0;    
      end
   end
end
...
begin
   ...
   begin
      if (col_cnt_is_128 && rx_top2rs_xgmii_rx_valid)
         rx_link_fault_status_xgmii_rx_data <= 2'b0;
      else if (seq_cnt_is_4 && rx_top2rs_xgmii_rx_valid)
...
begin
   ...
   begin
      if (fault_sequence_reg && rx_top2rs_xgmii_rx_valid)
      begin
