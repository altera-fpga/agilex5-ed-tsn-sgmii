...
proc alt_em10g32_constraint_std_sync {} {
    ...
    alt_em10g32_constraint_net_delay  *  *intel_eth_em10g32:*|alt_em10g32_std_synchronizer:*|din_s1  2.7ns
...
if {[expr ($INSERT_ST_ADAPTOR == 1)] || ([expr ($INSERT_XGMII_ADAPTOR == 1)] && [expr ($USE_ASYNC_ADAPTOR == 1)])} {
    ...
    if {[expr ($INSERT_XGMII_ADAPTOR == 1)] && [expr ($USE_ASYNC_ADAPTOR == 1)] && [expr ($ENABLE_TIMESTAMPING == 1)]} {
        ...
        set_multicycle_path -from [get_registers {*intel_eth_em10g32*alt_em10g_32_64_xgmii_conversion*alt_em10g_dcfifo_32_to_64_xgmii_conversion:tx_dcfifo_xgmii_conversion*transfer_valid_slow[0]}] -to [get_registers {*intel_eth_em10g32*alt_em10g_32_64_xgmii_conversion*alt_em10g_dcfifo_32_to_64_xgmii_conversion:tx_dcfifo_xgmii_conversion*transfer_valid_fast[0]}] -setup -end 2
        set_multicycle_path -from [get_registers {*intel_eth_em10g32*alt_em10g_32_64_xgmii_conversion*alt_em10g_dcfifo_32_to_64_xgmii_conversion:tx_dcfifo_xgmii_conversion*transfer_valid_slow[0]}] -to [get_registers {*intel_eth_em10g32*alt_em10g_32_64_xgmii_conversion*alt_em10g_dcfifo_32_to_64_xgmii_conversion:tx_dcfifo_xgmii_conversion*transfer_valid_fast[0]}] -hold -end 1
        
        set_multicycle_path -from [get_registers {*intel_eth_em10g32*alt_em10g_32_64_xgmii_conversion*alt_em10g_dcfifo_32_to_64_xgmii_conversion:tx_dcfifo_xgmii_conversion*xgmii_tx_path_latency_slow[*]}] -to [get_registers {*intel_eth_em10g32*alt_em10g_32_64_xgmii_conversion*alt_em10g_dcfifo_32_to_64_xgmii_conversion:tx_dcfifo_xgmii_conversion*xgmii_tx_path_latency_fast[*]}] -setup -end 2
        set_multicycle_path -from [get_registers {*intel_eth_em10g32*alt_em10g_32_64_xgmii_conversion*alt_em10g_dcfifo_32_to_64_xgmii_conversion:tx_dcfifo_xgmii_conversion*xgmii_tx_path_latency_slow[*]}] -to [get_registers {*intel_eth_em10g32*alt_em10g_32_64_xgmii_conversion*alt_em10g_dcfifo_32_to_64_xgmii_conversion:tx_dcfifo_xgmii_conversion*xgmii_tx_path_latency_fast[*]}] -hold -end 1
    }
}
...
if {[expr ($DATAPATH_OPTION == 1)] || [expr ($DATAPATH_OPTION == 3)]} {
    ...
    if {!(($ENABLE_1G10G_MAC == 0) || ($ENABLE_1G10G_MAC == 5))} {
    ...
    if {[expr ($INSERT_ST_ADAPTOR == 1)]} {
        set_false_path -from [get_registers {*alt_em10g32_creg_top:creg_top_inst|alt_em10g32_creg_map:alt_em10g32_creg_map_inst|tx_adptdcff_rdwtrmrk_dis}] -to [get_registers {*intel_eth_em10g32*altera_eth_avalon_st_adapter:st_adpt.avalon_st_adpt_inst|*}]
        set_false_path -from [get_registers {*alt_em10g32_creg_top:creg_top_inst|alt_em10g32_creg_map:alt_em10g32_creg_map_inst|tx_adptdcff_rdwtrmrk[*]}] -to [get_registers {*intel_eth_em10g32*altera_eth_avalon_st_adapter:st_adpt.avalon_st_adpt_inst|*}]
        set_false_path -from [get_registers {*alt_em10g32_creg_top:creg_top_inst|alt_em10g32_creg_map:alt_em10g32_creg_map_inst|tx_adptdcff_vldpkt_minwt[*]}] -to [get_registers {*intel_eth_em10g32*altera_eth_avalon_st_adapter:st_adpt.avalon_st_adpt_inst|*}]
