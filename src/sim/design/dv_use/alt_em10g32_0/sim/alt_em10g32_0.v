...
module alt_em10g32_0 (
	...
	intel_eth_em10g32 #(
		...
		.gmii16b_tx_clk                                 (gmii16b_tx_clk),                                                                                       //   input,   width = 1,     gmii16b_tx_clk.clk
		.gmii16b_tx_d                                   (gmii16b_tx_d),                                                                                         //  output,  width = 16,       gmii16b_tx_d.export
		.gmii16b_tx_en                                  (gmii16b_tx_en),                                                                                        //  output,   width = 2,      gmii16b_tx_en.export
		.gmii16b_tx_err                                 (gmii16b_tx_err),                                                                                       //  output,   width = 2,     gmii16b_tx_err.export
		...
		.gmii16b_rx_clk                                 (gmii16b_rx_clk),                                                                                       //   input,   width = 1,     gmii16b_rx_clk.clk
		.gmii16b_rx_d                                   (gmii16b_rx_d),                                                                                         //   input,  width = 16,       gmii16b_rx_d.export
		.gmii16b_rx_dv                                  (gmii16b_rx_dv),                                                                                        //   input,   width = 2,      gmii16b_rx_dv.export
		.gmii16b_rx_err                                 (gmii16b_rx_err),                                                                                       //   input,   width = 2,     gmii16b_rx_err.export
		...
		.tx_312_5_clk                                   (1'b0),                                                                                                 // (terminated),                                 
		.rx_312_5_clk                                   (1'b0),                                                                                                 // (terminated),                                 
		...
		.link_fault_status_xgmii_rx_data                (),                                                                                                     // (terminated),                                 
