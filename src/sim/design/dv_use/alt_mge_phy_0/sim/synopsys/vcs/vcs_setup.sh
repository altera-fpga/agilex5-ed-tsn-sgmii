...
# ACDS 23.4.1 162 linux 2023.12.20.01:59:00
...
source $QSYS_SIMDIR/common/vcs_files.tcl
set files [dict merge $files [alt_mge_phy_0::get_common_design_files "$QSYS_SIMDIR"]]
...
set QSYS_SIMDIR [lindex $argv 1]
source $QSYS_SIMDIR/common/vcs_files.tcl
if {[catch {alt_mge_phy_0::get_design_files "$QSYS_SIMDIR"} errorMsg]} {
 puts "Catch error: $errorMsg"
 exit 1 
}
set files [dict create]
set files [dict merge $files [alt_mge_phy_0::get_design_files "$QSYS_SIMDIR"]]
