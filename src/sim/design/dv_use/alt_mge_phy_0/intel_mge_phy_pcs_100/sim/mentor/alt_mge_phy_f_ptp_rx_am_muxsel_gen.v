...
module alt_mge_phy_f_ptp_rx_am_muxsel_gen #(
...
reg [8:0]   cnt_delay0; // Delay between sync and async pulses
wire        async_pulse_sync;
reg         async_pulse_sync_d0;
reg         dl_measure_en;

assign rx_mux_sel = mux_sel_reg;
assign rx_dl_measure_en = dl_measure_en;
