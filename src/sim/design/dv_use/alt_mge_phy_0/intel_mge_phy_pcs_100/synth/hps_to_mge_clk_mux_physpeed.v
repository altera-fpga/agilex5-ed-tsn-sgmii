...
module hps_to_mge_clk_mux_physpeed (
   input          clk_in1,
   input          rstn_clk1,
   input          clk_in2,
   input          rstn_clk2,
...
always @(posedge clk_in1 or negedge rstn_clk1) begin
   if (!rstn_clk1)
      ...
      if ((sel == 3'b1 || sel == 3'd4 ) && sel_stg2_clk2 == 1'b0 && sel_stg2_clk3 == 1'b0)
         sel_stg1_clk1   <= 1'b1;
      else
         sel_stg1_clk1   <= 1'b0;
   end
...
always @(posedge clk_in2 or negedge rstn_clk2) begin
   if (!rstn_clk2)
      ...
      if (sel == 3'b010 && sel_stg2_clk1 == 1'b0 && sel_stg2_clk3 == 1'b0)
         sel_stg1_clk2   <= 1'b1;
      else
         sel_stg1_clk2   <= 1'b0;
   end
...
always @(posedge clk_in3 or negedge rstn_clk3) begin
   if (!rstn_clk3)
      ...
      if (sel == 3'b011 && sel_stg2_clk1 == 1'b0 && sel_stg2_clk2 == 1'b0)
         sel_stg1_clk3   <= 1'b1;
      else
         sel_stg1_clk3   <= 1'b0;
   end
