// alt_mge_phy_0_one_lane_hal_pldif_hal_2100_g7omyzi.v

// Generated using ACDS version 23.4.1 162

`timescale 1 ps / 1 ps
module alt_mge_phy_0_one_lane_hal_pldif_hal_2100_g7omyzi #(
		...
		parameter       ch_pldif_l_tx_user1_clk_dynamic_mux_atom = "TX_USER1_CLK_DYNAMIC_MUX_C0",
		...
		parameter[35:0] ch_pldif_rx_fifo_wr_clk_hz_atom          = 36'b000000010011001101010110001000011001,
		parameter[35:0] ch_pldif_tx_fifo_rd_clk_hz_atom          = 36'b000000010011001101010110001000011001,
		...
		parameter       ch_pcs_l_tx_bond_size_atom               = "TX_BOND_SIZE_X1",
	...
	generate
		...
		if (ch_pldif_l_tx_fifo_width_atom != "TX_FIFO_WIDTH_DOUBLE_WIDTH")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (ch_pldif_l_tx_user1_clk_dynamic_mux_atom != "TX_USER1_CLK_DYNAMIC_MUX_C0")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (ch_pldif_rx_fifo_wr_clk_hz_atom != 36'b000000010011001101010110001000011001)
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (ch_pldif_tx_fifo_rd_clk_hz_atom != 36'b000000010011001101010110001000011001)
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (ch_pcs_l_tx_bond_size_atom != "TX_BOND_SIZE_X1")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (ch_pldif_l_stmux_tx_demux_sel != "SEL_ETH")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
		...
		if (ch_pldif_l_stmux_tx_fifo_rd_clk_mux_sel != "SEL_ETH_OR_PTP")
		begin
		// synthesis translate_off
			initial begin
				$display("Generated module instantiated with wrong parameters");
	...
	alt_mge_phy_0_pldif_hal_2100_4ge3b5q #(
		...
		.ch_pldif_l_tx_fifo_width_atom            ("TX_FIFO_WIDTH_DOUBLE_WIDTH"),
		...
		.ch_pldif_l_tx_user1_clk_dynamic_mux_atom ("TX_USER1_CLK_DYNAMIC_MUX_C0"),
		...
		.ch_pldif_rx_fifo_wr_clk_hz_atom          (36'b000000010011001101010110001000011001),
		.ch_pldif_tx_fifo_rd_clk_hz_atom          (36'b000000010011001101010110001000011001),
