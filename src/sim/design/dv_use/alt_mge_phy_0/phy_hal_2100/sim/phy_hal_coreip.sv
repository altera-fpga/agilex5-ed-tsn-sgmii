...
`ifdef ALTERA_RESERVED_QIS
    ...
    `ifdef ch_pcie_mode_atom == "PCIE_MODE_DISABLED"
        .x_std_ipfluxtop_uxtop_wrap_0__rx_adaptation_mode                   ("RX_ADAPTATION_MODE_FLUX_ADAPTATION"),
        .x_std_sm_flux_ingress_0__flux_mode                                 ("FLUX_MODE_FLUX_MODE_SNIFFER"),
    `else
